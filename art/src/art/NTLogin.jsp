    ...
    <body onload="javascript:document.getElementById('username').focus();">
        <table cellSpacing="1" cellPadding="5" width="300" height="300" border="0" class="art" valign="middle" align="center">
            ...
            <form name="login" method="post" action="${pageContext.request.contextPath}/execNTLogin.jsp">
                ...
                <tr>
                    <td vAlign="center" align="right" width="50%"><%=messages.getString("domain")%></td>
                ...
                <tr>
                    ...
                    <td vAlign="center" align="left" width="50%">
                        <input id="username" maxLength="15" size="16" name="ntusername">
                    </td>
                </tr>
                <tr>
                    <td vAlign="center" align="right" width="50%"><%=messages.getString("password")%></td>
                    <td vAlign="center" align="left" width="50%">
                        <input id="password" type="password" maxLength="40" size="16" name="ntpassword">
                    </td>
                </tr>
                <tr>
