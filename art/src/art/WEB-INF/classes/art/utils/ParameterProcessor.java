 ...
 *
 * Caller:	QueryExecute, editJob.jsp
 * Purpose:	parse the request parameter and feed the
 *              hash tables
 * Note:	Parameters that begin with _ are ignored
 *              as well as the ones in the first IF below
 */
package art.utils;
...
public class ParameterProcessor {
     ...
     * @return parameters to be shown in report if show parameters option is selected
     */
