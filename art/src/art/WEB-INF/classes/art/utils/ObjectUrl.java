...
public class ObjectUrl {
	...
	* If objects have parameters, the default values are used
	...
	/** Returns the URL to directly execute the object.
	*
	* getDefaulParams stares if the URL should contain the default parameters or not
     * 
     * @param objectId 
     * @param encodeUrl 
	...
	* If objects have parameters, the default values are used
	...
	/** Build the portion of the URL with
	*  default parameter values
	*  If encodeUrl is true, the parameters values are encoded (used when printing the link)
	*/
	...
	/** Build the URL used to execute the query/object
	*  (without any parameter value)
	* // change 1.8 to /user/<servlet> instead of /<servlet>
	*/
