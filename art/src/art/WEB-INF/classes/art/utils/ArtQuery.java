...
public class ArtQuery {
	...
	/**
	 *
	 * @return setting to determine whether show parameters option will be
	 * checked or not
	 */
	 ...
	 * access already granted to the user
	 *
	 * @param conn
	 * @param username
	...
	/**
	 * Return mondrian roles. Jpivot seems to have a problem when more than one
	 * role returned
	 *
	 * @param conn
	 * @param username
	 ...
	 *
	 * @param qId
	 * @param fillParams <code>true</code> if parameters data structures for the
	 * drill down queries should be built
	 * @return drill down queries for a given query
	 */
	 ...
	 * @param qId
	 * @param label
	 * @return <code>true</code> if parameter label validly exists in the sql
	 * source
	 */
	...
	/**
	 * Determine if parameter values should be shown for a query Especially for
	 * drill down queries where there's no chance to check/uncheck the show
