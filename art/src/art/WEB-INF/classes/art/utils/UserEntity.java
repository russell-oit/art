 ...
 */
/**
 * This class is stored in the user Session and provide entities
 * associated with the user (groups, queries. jobs etc)
...
public class UserEntity implements Serializable {
     ...
     * @param value algorithm used to hash the password. One of bcrypt, MD5, SHA-1
     */
     ...
     */
    public Map getSharedJobs() {
        TreeMap<Integer, ArtJob> jobs = new TreeMap<Integer, ArtJob>();
        ...
        try {
            ...
            //get shared jobs user has access to via group membership. non-spit jobs. no entries for them in the shared jobs table
    ...
    /**
     * Get an indicator of which junior and mid admins have access to which datasources
     * 
     * @return an indicator of which junior and mid admins have access to which datasources
     */
