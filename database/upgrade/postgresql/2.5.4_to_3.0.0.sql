...
INSERT INTO ART_DATABASE_VERSION VALUES('3.0-rc4', 0);

-- reset x_axis_label column for non-graph queries
UPDATE ART_QUERIES SET X_AXIS_LABEL='' WHERE QUERY_TYPE>=0;

-- decrease size of x_axis_label column
UPDATE ART_QUERIES SET X_AXIS_LABEL=SUBSTR(X_AXIS_LABEL,1,50);
ALTER TABLE ART_QUERIES ALTER COLUMN X_AXIS_LABEL TYPE VARCHAR(50);
...
-- increase size of log_type column
ALTER TABLE ART_LOGS ALTER COLUMN LOG_TYPE TYPE VARCHAR(50);

-- increase size of username columns
ALTER TABLE ART_USERS ALTER COLUMN USERNAME TYPE VARCHAR(50);
ALTER TABLE ART_DATABASES ALTER COLUMN USERNAME TYPE VARCHAR(50);
ALTER TABLE ART_ADMIN_PRIVILEGES ALTER COLUMN USERNAME TYPE VARCHAR(50);
ALTER TABLE ART_USER_QUERIES ALTER COLUMN USERNAME TYPE VARCHAR(50);
ALTER TABLE ART_USER_QUERY_GROUPS ALTER COLUMN USERNAME TYPE VARCHAR(50);
ALTER TABLE ART_USER_RULES ALTER COLUMN USERNAME TYPE VARCHAR(50);
ALTER TABLE ART_JOBS ALTER COLUMN USERNAME TYPE VARCHAR(50);
ALTER TABLE ART_JOBS_AUDIT ALTER COLUMN USERNAME TYPE VARCHAR(50);
ALTER TABLE ART_LOGS ALTER COLUMN USERNAME TYPE VARCHAR(50);
ALTER TABLE ART_USER_JOBS ALTER COLUMN USERNAME TYPE VARCHAR(50);
ALTER TABLE ART_USER_GROUP_ASSIGNMENT ALTER COLUMN USERNAME TYPE VARCHAR(50);
ALTER TABLE ART_JOB_ARCHIVES ALTER COLUMN USERNAME TYPE VARCHAR(50);

-- change update_date columns to timestamps
 ALTER TABLE ART_USERS ALTER COLUMN UPDATE_DATE TYPE TIMESTAMP;
 ALTER TABLE ART_DATABASES ALTER COLUMN UPDATE_DATE TYPE TIMESTAMP;
 ALTER TABLE ART_QUERIES ALTER COLUMN UPDATE_DATE TYPE TIMESTAMP;
 ALTER TABLE ART_USER_QUERIES DROP COLUMN UPDATE_DATE;
 ALTER TABLE ART_QUERY_FIELDS ALTER COLUMN UPDATE_DATE TYPE TIMESTAMP;
 
-- change jobs start and end dates to timestamps
ALTER TABLE ART_JOBS ALTER COLUMN START_DATE TYPE TIMESTAMP;
ALTER TABLE ART_JOBS ALTER COLUMN END_DATE TYPE TIMESTAMP;
...
UPDATE ART_LOGS SET MESSAGE=SUBSTR(MESSAGE,1,500);
ALTER TABLE ART_LOGS ALTER COLUMN MESSAGE TYPE VARCHAR(500);
...
ALTER TABLE ART_DATABASES ALTER COLUMN PASSWORD TYPE VARCHAR(100);
...
ALTER TABLE ART_USERS ALTER COLUMN FULL_NAME TYPE VARCHAR(100);
ALTER TABLE ART_USERS ALTER COLUMN EMAIL TYPE VARCHAR(100);
...
ALTER TABLE ART_QUERIES ALTER COLUMN CONTACT_PERSON TYPE VARCHAR(100);

-- increase size of datasource name column
ALTER TABLE ART_DATABASES ALTER COLUMN NAME TYPE VARCHAR(50);

-- increase size of datasource username column
ALTER TABLE ART_DATABASES ALTER COLUMN USERNAME TYPE VARCHAR(50);

-- increase size of report groups name column
ALTER TABLE ART_QUERY_GROUPS ALTER COLUMN NAME TYPE VARCHAR(50);

-- increase size of report groups description column
ALTER TABLE ART_QUERY_GROUPS ALTER COLUMN DESCRIPTION TYPE VARCHAR(100);

-- increase size of rule name column
ALTER TABLE ART_RULES ALTER COLUMN RULE_NAME TYPE VARCHAR(50);

-- increase size of rule description column
ALTER TABLE ART_RULES ALTER COLUMN SHORT_DESCRIPTION TYPE VARCHAR(100);

-- increase size of query rules rule name column
ALTER TABLE ART_QUERY_RULES ALTER COLUMN RULE_NAME TYPE VARCHAR(50);

-- increase size of user rules rule name column
ALTER TABLE ART_USER_RULES ALTER COLUMN RULE_NAME TYPE VARCHAR(50);

-- increase size of user rules rule value column
ALTER TABLE ART_USER_RULES ALTER COLUMN RULE_VALUE TYPE VARCHAR(100);

-- increase size of user group rules rule name column
ALTER TABLE ART_USER_GROUP_RULES ALTER COLUMN RULE_NAME TYPE VARCHAR(50);

-- increase size of user group rules rule value column
ALTER TABLE ART_USER_GROUP_RULES ALTER COLUMN RULE_VALUE TYPE VARCHAR(100);

-- increase size of logs ip column
ALTER TABLE ART_LOGS ALTER COLUMN IP TYPE VARCHAR(50);

-- increase size of user groups name column
ALTER TABLE ART_USER_GROUPS ALTER COLUMN NAME TYPE VARCHAR(50);

-- increase size of user groups description column
ALTER TABLE ART_USER_GROUPS ALTER COLUMN DESCRIPTION TYPE VARCHAR(100);

-- increase size of drill down title column
ALTER TABLE ART_DRILLDOWN_QUERIES ALTER COLUMN DRILLDOWN_TITLE TYPE VARCHAR(50);

-- increase size of drill down title column
ALTER TABLE ART_DRILLDOWN_QUERIES ALTER COLUMN DRILLDOWN_TEXT TYPE VARCHAR(50);
