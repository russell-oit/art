...
ALTER TABLE ART_QUERIES ADD OLD_USES_RULES VARCHAR(1);
UPDATE ART_QUERIES SET OLD_USES_RULES=USES_RULES;
ALTER TABLE ART_QUERIES DROP COLUMN USES_RULES;
ALTER TABLE ART_QUERIES ADD USES_RULES INTEGER;
UPDATE ART_QUERIES SET USES_RULES=1 WHERE OLD_USES_RULES='Y';
ALTER TABLE ART_QUERIES DROP COLUMN OLD_USES_RULES;
...
ALTER TABLE ART_QUERIES ADD OLD_SHOW_PARAMETERS VARCHAR(1);
UPDATE ART_QUERIES SET OLD_SHOW_PARAMETERS=SHOW_PARAMETERS;
ALTER TABLE ART_QUERIES DROP COLUMN SHOW_PARAMETERS;
ALTER TABLE ART_QUERIES ADD SHOW_PARAMETERS INTEGER;
UPDATE ART_QUERIES SET SHOW_PARAMETERS=1 WHERE OLD_SHOW_PARAMETERS='Y' OR OLD_SHOW_PARAMETERS='A';
ALTER TABLE ART_QUERIES DROP COLUMN OLD_SHOW_PARAMETERS;
