...
ALTER TABLE ART_QUERIES ADD CREATION_DATE TIMESTAMP NULL;
ALTER TABLE ART_USER_GROUPS ADD CREATION_DATE TIMESTAMP NULL;
ALTER TABLE ART_USER_GROUPS ADD UPDATE_DATE TIMESTAMP NULL;
ALTER TABLE ART_DATABASES ADD CREATION_DATE TIMESTAMP NULL;
