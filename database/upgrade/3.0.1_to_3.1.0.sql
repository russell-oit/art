...
-- make some varchar columns nullable
ALTER TABLE ART_QUERIES ADD SHORT_DESCRIPTION_TEMP VARCHAR(254);
UPDATE ART_QUERIES SET SHORT_DESCRIPTION_TEMP=SHORT_DESCRIPTION;
ALTER TABLE ART_QUERIES DROP COLUMN SHORT_DESCRIPTION;
ALTER TABLE ART_QUERIES ADD SHORT_DESCRIPTION VARCHAR(254);
UPDATE ART_QUERIES SET SHORT_DESCRIPTION=SHORT_DESCRIPTION_TEMP;
ALTER TABLE ART_QUERIES DROP COLUMN SHORT_DESCRIPTION_TEMP;

ALTER TABLE ART_QUERIES ADD DESCRIPTION_TEMP VARCHAR(2000);
UPDATE ART_QUERIES SET DESCRIPTION_TEMP=DESCRIPTION;
ALTER TABLE ART_QUERIES DROP COLUMN DESCRIPTION;
ALTER TABLE ART_QUERIES ADD DESCRIPTION VARCHAR(2000);
UPDATE ART_QUERIES SET DESCRIPTION=DESCRIPTION_TEMP;
ALTER TABLE ART_QUERIES DROP COLUMN DESCRIPTION_TEMP;

ALTER TABLE ART_USERS ADD PASSWORD_TEMP VARCHAR(200);
UPDATE ART_USERS SET PASSWORD_TEMP=PASSWORD;
ALTER TABLE ART_USERS DROP COLUMN PASSWORD;
ALTER TABLE ART_USERS ADD PASSWORD VARCHAR(200);
UPDATE ART_USERS SET PASSWORD=PASSWORD_TEMP;
ALTER TABLE ART_USERS DROP COLUMN PASSWORD_TEMP;

ALTER TABLE ART_DATABASES ADD DRIVER_TEMP VARCHAR(200);
UPDATE ART_DATABASES SET DRIVER_TEMP=DRIVER;
ALTER TABLE ART_DATABASES DROP COLUMN DRIVER;
ALTER TABLE ART_DATABASES ADD DRIVER VARCHAR(200);
UPDATE ART_DATABASES SET DRIVER=DRIVER_TEMP;
ALTER TABLE ART_DATABASES DROP COLUMN DRIVER_TEMP;

ALTER TABLE ART_DATABASES ADD URL_TEMP VARCHAR(2000);
UPDATE ART_DATABASES SET URL_TEMP=URL;
ALTER TABLE ART_DATABASES DROP COLUMN URL;
ALTER TABLE ART_DATABASES ADD URL VARCHAR(2000);
UPDATE ART_DATABASES SET URL=URL_TEMP;
ALTER TABLE ART_DATABASES DROP COLUMN URL_TEMP;

ALTER TABLE ART_DATABASES ADD USERNAME_TEMP VARCHAR(50);
UPDATE ART_DATABASES SET USERNAME_TEMP=USERNAME;
ALTER TABLE ART_DATABASES DROP COLUMN USERNAME;
ALTER TABLE ART_DATABASES ADD USERNAME VARCHAR(50);
UPDATE ART_DATABASES SET USERNAME=USERNAME_TEMP;
ALTER TABLE ART_DATABASES DROP COLUMN USERNAME_TEMP;

ALTER TABLE ART_DATABASES ADD PASSWORD_TEMP VARCHAR(100);
UPDATE ART_DATABASES SET PASSWORD_TEMP=PASSWORD;
ALTER TABLE ART_DATABASES DROP COLUMN PASSWORD;
ALTER TABLE ART_DATABASES ADD PASSWORD VARCHAR(100);
UPDATE ART_DATABASES SET PASSWORD=PASSWORD_TEMP;
ALTER TABLE ART_DATABASES DROP COLUMN PASSWORD_TEMP;