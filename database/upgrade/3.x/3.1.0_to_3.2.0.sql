...
-- update names of destination types
...
-- update database version
UPDATE ART_DATABASE_VERSION SET DATABASE_VERSION='3.2';
...
-- change jobs message column to clob
ALTER TABLE ART_JOBS ADD MESSAGE_TEMP VARCHAR(4000);
UPDATE ART_JOBS SET MESSAGE_TEMP=MESSAGE;
ALTER TABLE ART_JOBS DROP COLUMN MESSAGE;
ALTER TABLE ART_JOBS ADD MESSAGE CLOB;
UPDATE ART_JOBS SET MESSAGE=MESSAGE_TEMP;
ALTER TABLE ART_JOBS DROP COLUMN MESSAGE_TEMP;
...
UPDATE ART_DESTINATIONS SET DESTINATION_TYPE='Microsoft Azure' WHERE DESTINATION_TYPE='Azure';
