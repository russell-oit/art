...
ALTER TABLE ART_JOBS_AUDIT ADD CONSTRAINT aja_fk_j_id FOREIGN KEY(JOB_ID) REFERENCES ART_JOBS(JOB_ID);
ALTER TABLE ART_JOBS_AUDIT ADD CONSTRAINT aja_fk_u_id FOREIGN KEY(USER_ID) REFERENCES ART_USERS(USER_ID);
