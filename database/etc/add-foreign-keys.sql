...
ALTER TABLE ART_USER_REPORT_MAP ADD CONSTRAINT art_urptm_fk_u_id FOREIGN KEY(USER_ID) REFERENCES ART_USERS(USER_ID);
ALTER TABLE ART_USER_REPORT_MAP ADD CONSTRAINT art_urptm_fk_r_id FOREIGN KEY(REPORT_ID) REFERENCES ART_QUERIES(QUERY_ID);
...
ALTER TABLE ART_USER_JOB_MAP ADD CONSTRAINT art_ujm_fk_j_id FOREIGN KEY(JOB_ID) REFERENCES ART_JOBS(JOB_ID);
ALTER TABLE ART_USER_JOB_MAP ADD CONSTRAINT art_ujm_fk_u_id FOREIGN KEY(USER_ID) REFERENCES ART_USERS(USER_ID);
ALTER TABLE ART_USER_JOB_MAP ADD CONSTRAINT art_ujm_fk_ug_id FOREIGN KEY(USER_GROUP_ID) REFERENCES ART_USER_GROUPS(USER_GROUP_ID);
...
ALTER TABLE ART_ROLE_PERMISSION_MAP ADD CONSTRAINT art_rpm_fk_r_id FOREIGN KEY(ROLE_ID) REFERENCES ART_ROLES(ROLE_ID);
ALTER TABLE ART_ROLE_PERMISSION_MAP ADD CONSTRAINT art_rpm_fk_p_id FOREIGN KEY(PERMISSION_ID) REFERENCES ART_PERMISSIONS(PERMISSION_ID);
ALTER TABLE ART_USER_ROLE_MAP ADD CONSTRAINT art_urm_fk_u_id FOREIGN KEY(USER_ID) REFERENCES ART_USERS(USER_ID);
ALTER TABLE ART_USER_ROLE_MAP ADD CONSTRAINT art_urm_fk_r_id FOREIGN KEY(ROLE_ID) REFERENCES ART_ROLES(ROLE_ID);
ALTER TABLE ART_USER_GROUP_ROLE_MAP ADD CONSTRAINT art_ugrm_fk_ug_id FOREIGN KEY(USER_GROUP_ID) REFERENCES ART_USER_GROUPS(USER_GROUP_ID);
ALTER TABLE ART_USER_GROUP_ROLE_MAP ADD CONSTRAINT art_ugrm_fk_r_id FOREIGN KEY(ROLE_ID) REFERENCES ART_ROLES(ROLE_ID);
ALTER TABLE ART_USER_PERMISSION_MAP ADD CONSTRAINT art_upm_fk_u_id FOREIGN KEY(USER_ID) REFERENCES ART_USERS(USER_ID);
ALTER TABLE ART_USER_PERMISSION_MAP ADD CONSTRAINT art_upm_fk_p_id FOREIGN KEY(PERMISSION_ID) REFERENCES ART_PERMISSIONS(PERMISSION_ID);
ALTER TABLE ART_USER_GROUP_PERM_MAP ADD CONSTRAINT art_ugpm_fk_ug_id FOREIGN KEY(USER_GROUP_ID) REFERENCES ART_USER_GROUPS(USER_GROUP_ID);
ALTER TABLE ART_USER_GROUP_PERM_MAP ADD CONSTRAINT art_ugpm_fk_p_id FOREIGN KEY(PERMISSION_ID) REFERENCES ART_PERMISSIONS(PERMISSION_ID);
