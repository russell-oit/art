...
ALTER TABLE ART_JOBS DROP CONSTRAINT art_jb_fk_sc_id;
...
ALTER TABLE ART_PIPELINES DROP CONSTRAINT art_ppln_fk_sc_id;
ALTER TABLE ART_SETTINGS DROP CONSTRAINT art_st_fk_ss_id;
ALTER TABLE ART_SETTINGS DROP CONSTRAINT art_st_fk_ld_id;
