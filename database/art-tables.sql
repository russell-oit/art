...
(	
	...
	CONSTRAINT art_admp_pk PRIMARY KEY(USERNAME, PRIVILEGE, VALUE_ID)	
);
...
(
	...
	CONSTRAINT art_drq_pk PRIMARY KEY(QUERY_ID, DRILLDOWN_QUERY_POSITION)	
);
...
(
	SCHEDULE_ID INTEGER NOT NULL,
	HOLIDAY_ID INTEGER NOT NULL,
	CONSTRAINT art_schldm_pk PRIMARY KEY(SCHEDULE_ID, HOLIDAY_ID)
);
