...
ALTER TABLE ART_USERS ADD CONSTRAINT art_users_uc_username UNIQUE (USERNAME);
...
-- USE_RULES: boolean. 0=false, 1=true
...
-- ART_QUERY_TYPES
-- Reference table for query types

-- query type 1-99 are group queries. only 1-5 is stored in the reference table
