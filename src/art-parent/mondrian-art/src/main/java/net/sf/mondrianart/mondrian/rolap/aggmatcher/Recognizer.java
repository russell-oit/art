...
//printNotSeenForeignKeys(notSeenForeignKeys);
    ...
    /**
     * Given a {@link net.sf.mondrianart.mondrian.olap.MondrianDef.Expression}, returns
     * the associated column name.
     *
     * <p>Note: if the {@link net.sf.mondrianart.mondrian.olap.MondrianDef.Expression} is
     * not a {@link net.sf.mondrianart.mondrian.olap.MondrianDef.Column} or {@link
