 ...
 * static methods in {@link net.sf.mondrianart.mondrian.olap.Util}, namely:<ul>
 * <li>{@link net.sf.mondrianart.mondrian.olap.Util#makeBigDecimalFromDouble(double)}</li>
 * <li>{@link net.sf.mondrianart.mondrian.olap.Util#quotePattern(String)}</li>
 * </ul></p>
 *
