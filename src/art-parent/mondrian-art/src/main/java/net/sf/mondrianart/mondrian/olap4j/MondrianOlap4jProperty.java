 ...
 * {@link net.sf.mondrianart.mondrian.olap.Property}.
 *
 * @author jhyde
 * @since Nov 12, 2007
 */
class MondrianOlap4jProperty implements Property, Named {
    ...
    static {
        ...
        for (net.sf.mondrianart.mondrian.olap.Property o
            : net.sf.mondrianart.mondrian.olap.Property.enumeration.getValuesSortedByName())
        {
    ...
    final net.sf.mondrianart.mondrian.olap.Property property;

    MondrianOlap4jProperty(net.sf.mondrianart.mondrian.olap.Property property) {
