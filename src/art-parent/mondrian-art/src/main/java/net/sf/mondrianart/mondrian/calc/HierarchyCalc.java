...
/**
 * Expression which yields a {@link net.sf.mondrianart.mondrian.olap.Hierarchy}.
 *
 * <p>When implementing this interface, it is convenient to extend
 * {@link net.sf.mondrianart.mondrian.calc.impl.AbstractHierarchyCalc}, but it is not required.
 *
 * @author jhyde
 * @since Sep 26, 2005
 */
