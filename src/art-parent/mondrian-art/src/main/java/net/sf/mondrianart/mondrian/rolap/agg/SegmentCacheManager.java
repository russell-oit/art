...
import net.sf.mondrianart.mondrian.olap.CacheControl.CellRegion;
import net.sf.mondrianart.mondrian.rolap.*;
import net.sf.mondrianart.mondrian.rolap.cache.*;
import net.sf.mondrianart.mondrian.server.Execution;
...
import net.sf.mondrianart.mondrian.util.ByteString;
 ...
 * by a {@link net.sf.mondrianart.mondrian.spi.SegmentCache}.
 *
 * <p>Segment states</p>
 *
 * <table>
 ...
 *
 * <p>3. Delete {@link net.sf.mondrianart.mondrian.rolap.RolapStar#lookupOrCreateAggregation}
 * and {@link net.sf.mondrianart.mondrian.rolap.RolapStar#lookupSegment}
 * and {@link net.sf.mondrianart.mondrian.rolap.RolapStar}.lookupAggregationShared
 ...
 *
 * <p>1. {@link net.sf.mondrianart.mondrian.rolap.RolapStar#getCellFromCache} moved from
 ...
 *
 * <p>8. Longer term. Move {@link net.sf.mondrianart.mondrian.rolap.RolapStar.Bar}.segmentRefs to
 * {@link net.sf.mondrianart.mondrian.server.Execution}. Would it still be thread-local?</p>
 *
 * <p>10. Call
 * {@link net.sf.mondrianart.mondrian.spi.DataSourceChangeListener#isAggregationChanged}.
 ...
 * {@link net.sf.mondrianart.mondrian.rolap.agg.SegmentBuilder.SegmentConverter} is a hack that
 ...
 * {@link net.sf.mondrianart.mondrian.rolap.agg.SegmentCacheManager#peek}.</p>
 *
 ...
 * copying.</p>
 *
 * <p>21. Obsolete {@link net.sf.mondrianart.mondrian.util.CombiningGenerator}.</p>
 *
...
public class SegmentCacheManager {
    ...
    public final ExecutorService cacheExecutor =
        Util.getExecutorService(
            10, 0, 1, -1,
            "net.sf.mondrianart.mondrian.rolap.agg.SegmentCacheManager$cacheExecutor");
    ...
    public final ExecutorService sqlExecutor =
        Util.getExecutorService(
            10, 0, 1, 10,
            "net.sf.mondrianart.mondrian.rolap.agg.SegmentCacheManager$sqlExecutor");
    ...
    public SegmentCacheManager(MondrianServer server) {
        ...
        ACTOR = new Actor();
        thread = new Thread(
            ACTOR, "net.sf.mondrianart.mondrian.rolap.agg.SegmentCacheManager$ACTOR");
    ...
    private static abstract class Event implements Message {
         ...
         * {@link net.sf.mondrianart.mondrian.server.monitor.Visitor}.
         *
     ...
     * {@link net.sf.mondrianart.mondrian.server.monitor.Monitor}. Consider
    ...
    /**
     * Copy-pasted from {@link net.sf.mondrianart.mondrian.server.monitor.Monitor}. Consider
