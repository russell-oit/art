 ...
 * {@link net.sf.mondrianart.mondrian.olap.MondrianServer servers} to do things differently.
 *
 * @author jhyde
 * @since 2010/11/12
 */
public interface CatalogFinder {
     ...
     * {@link net.sf.mondrianart.mondrian.rolap.RolapSchema#getName()}. In fact, a given schema
