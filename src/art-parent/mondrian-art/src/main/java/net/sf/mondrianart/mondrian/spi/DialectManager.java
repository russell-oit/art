...
import net.sf.mondrianart.mondrian.spi.impl.JdbcDialectFactory;
import net.sf.mondrianart.mondrian.spi.impl.JdbcDialectImpl;
import net.sf.mondrianart.mondrian.util.ServiceDiscovery;
...
/**
 * Manages {@link net.sf.mondrianart.mondrian.spi.Dialect} and {@link net.sf.mondrianart.mondrian.spi.DialectFactory}
 * objects.
 *
 * @author jhyde
 * @since Jan 13, 2009
...
public abstract class DialectManager {
    ...
    /**
     * Implementation class for {@link net.sf.mondrianart.mondrian.spi.DialectManager}.
     *
    ...
    private static class DialectManagerImpl {
         ...
         * {@link net.sf.mondrianart.mondrian.util.ServiceDiscovery} for more details.)
         */
        DialectManagerImpl() {
    ...
    /**
     * Implementation of {@link net.sf.mondrianart.mondrian.spi.DialectFactory} that caches
