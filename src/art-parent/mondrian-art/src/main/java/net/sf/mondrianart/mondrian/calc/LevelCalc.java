...
/**
 * Expression which yields a {@link net.sf.mondrianart.mondrian.olap.Level}.
 *
 * <p>When implementing this interface, it is convenient to extend
 * {@link net.sf.mondrianart.mondrian.calc.impl.AbstractLevelCalc}, but it is not required.
 *
 * @author jhyde
 * @since Sep 26, 2005
 */
