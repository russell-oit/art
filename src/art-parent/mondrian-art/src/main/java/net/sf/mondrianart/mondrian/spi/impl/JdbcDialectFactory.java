...
import net.sf.mondrianart.mondrian.spi.DialectFactory;
...
/**
 * Implementation of {@link net.sf.mondrianart.mondrian.spi.DialectFactory} for subclasses
 * of {@link net.sf.mondrianart.mondrian.spi.impl.JdbcDialectImpl}.
 *
...
public class JdbcDialectFactory implements DialectFactory {
     ...
     * {@link net.sf.mondrianart.mondrian.spi.DialectFactory#createDialect(javax.sql.DataSource, java.sql.Connection)}.
     *
