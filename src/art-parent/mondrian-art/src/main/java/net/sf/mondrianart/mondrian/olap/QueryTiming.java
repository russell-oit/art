 ...
 * {@link net.sf.mondrianart.mondrian.server.Statement#enableProfiling} and implement the
 * {@link net.sf.mondrianart.mondrian.spi.ProfileHandler#explain(String, QueryTiming)} method.
 *
 * @author jbarnett
 */
