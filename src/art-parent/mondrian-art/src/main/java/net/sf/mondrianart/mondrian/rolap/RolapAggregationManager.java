 ...
 * {@link net.sf.mondrianart.mondrian.rolap.agg.Segment}s in the system.
 *
 ...
 * in the derived class, {@link net.sf.mondrianart.mondrian.rolap.agg.AggregationManager}.
 *
 * @author jhyde
...
public abstract class RolapAggregationManager {
    ...
    /**
     * Returns a {@link net.sf.mondrianart.mondrian.rolap.CellReader} which reads cells from cache.
     */
