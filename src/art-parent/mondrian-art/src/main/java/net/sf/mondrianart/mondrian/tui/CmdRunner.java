...
// All Rights Reserved.
*/
package net.sf.mondrianart.mondrian.tui;
...
public class CmdRunner {
    ...
    public Expr parseParameter(String value) {
        ...
        if (element instanceof Member) {
            ...
            net.sf.mondrianart.mondrian.olap.Level level = (net.sf.mondrianart.mondrian.olap.Level) element;
...
*/
    ...
    private static void setDefaultCommentState() {
        allowNestedComments = net.sf.mondrianart.mondrian.olap.Scanner.getNestedCommentsState();
        String[][] scannerCommentsDelimiters =
            net.sf.mondrianart.mondrian.olap.Scanner.getCommentDelimiters();
