...
import net.sf.mondrianart.mondrian.olap.fun.Resolver;
...
public class Util extends XOMUtil {
     ...
     * things are available via {@link net.sf.mondrianart.mondrian.util.UtilCompatible}.
    ...
    static {
        ...
        if (PreJdk15 || Retrowoven) {
            className = "net.sf.mondrianart.mondrian.util.UtilCompatibleJdk14";
        } else if (PreJdk16) {
            className = "net.sf.mondrianart.mondrian.util.UtilCompatibleJdk15";
        } else {
     ...
     * In this case, the result will be a {@link net.sf.mondrianart.mondrian.mdx.ResolvedFunCall}.
     *
     ...
     *
     * @deprecated Use {@link net.sf.mondrianart.mondrian.server.monitor.Monitor#getServer()} and
     *  {@link net.sf.mondrianart.mondrian.server.monitor.ServerInfo#sqlStatementExecuteNanos};
