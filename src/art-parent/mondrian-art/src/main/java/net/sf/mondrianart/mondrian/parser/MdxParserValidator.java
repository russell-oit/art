...
public interface MdxParserValidator {
    ...
    /**
      * Parses a string to create a {@link net.sf.mondrianart.mondrian.olap.Query}.
      * Called only by {@link net.sf.mondrianart.mondrian.olap.ConnectionBase#parseQuery}.
      */
    ...
    interface QueryPartFactory {
        ...
        /**
         * Creates a {@link net.sf.mondrianart.mondrian.olap.Query} object.
        ...
        /**
         * Creates a {@link net.sf.mondrianart.mondrian.olap.DrillThrough} object.
         */
        ...
        /**
         * Creates an {@link net.sf.mondrianart.mondrian.olap.Explain} object.
         */
        Explain makeExplain(
            QueryPart query);
    }
