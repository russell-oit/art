...
import net.sf.mondrianart.mondrian.olap.AxisOrdinal;
import net.sf.mondrianart.mondrian.rolap.RolapAxis;
...
class MondrianOlap4jCellSetAxis implements CellSetAxis {
    ...
    private final net.sf.mondrianart.mondrian.olap.QueryAxis queryAxis;
    ...
    MondrianOlap4jCellSetAxis(
        ...
        net.sf.mondrianart.mondrian.olap.QueryAxis queryAxis,
        RolapAxis axis)
    {
        ...
        public List<Member> getMembers() {
            return new AbstractList<Member>() {
                public Member get(int slice) {
                    final net.sf.mondrianart.mondrian.olap.Member mondrianMember =
