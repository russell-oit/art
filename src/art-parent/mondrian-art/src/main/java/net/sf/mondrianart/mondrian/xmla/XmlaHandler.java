...
// All Rights Reserved.
*/
package net.sf.mondrianart.mondrian.xmla;

import net.sf.mondrianart.mondrian.olap.MondrianProperties;
import net.sf.mondrianart.mondrian.olap.Util;
import net.sf.mondrianart.mondrian.util.CompositeList;
import net.sf.mondrianart.mondrian.xmla.impl.DefaultSaxWriter;
...
import static net.sf.mondrianart.mondrian.xmla.XmlaConstants.*;
...
//                throw new SAXException("Too many axes: " + axisCount);
     ...
     * {@link net.sf.mondrianart.mondrian.olap.MondrianServer#getLockBox()} and pass in the moniker
     ...
     *
     * <p>The {@link net.sf.mondrianart.mondrian.xmla.XmlaHandler.XmlaExtraImpl} class provides
    ...
    /**
     * Default implementation of {@link net.sf.mondrianart.mondrian.xmla.XmlaHandler.XmlaExtra}.
