...
// All Rights Reserved.
*/
package net.sf.mondrianart.mondrian.rolap.aggmatcher;

import net.sf.mondrianart.mondrian.olap.*;
import net.sf.mondrianart.mondrian.olap.MondrianDef.AggLevel;
import net.sf.mondrianart.mondrian.recorder.MessageRecorder;
...
public class AggStar {
    ...
    public abstract class Table {
        ...
        public class JoinCondition {
            ...
            public void print(final PrintWriter pw, final String prefix) {
                ...
                if (left instanceof MondrianDef.Column) {
                    ...
                    net.sf.mondrianart.mondrian.rolap.RolapStar.Column col =
        ...
        /**
         * Converts a {@link net.sf.mondrianart.mondrian.rolap.RolapStar.Table} into a
