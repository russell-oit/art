...
import net.sf.mondrianart.mondrian.olap.fun.AggregateFunDef;
import net.sf.mondrianart.mondrian.olap.fun.VisualTotalsFunDef;
    ...
    implements RolapMember
{
     ...
     * {@link net.sf.mondrianart.mondrian.olap.CacheControl#createMoveCommand}.
     *
     ...
     * {@link net.sf.mondrianart.mondrian.olap.fun.FunUtil#compareHierarchically}.
     *
    ...
    public interface PropertyValueMapFactory {
         ...
         * {@link net.sf.mondrianart.mondrian.olap.Member}.
         *
         * @param member Member
     ...
     * {@link net.sf.mondrianart.mondrian.olap.MondrianProperties#PropertyValueMapFactoryClass}
     * is not set.
     */
        ...
        implements PropertyValueMapFactory
    {
         ...
         * {@link net.sf.mondrianart.mondrian.olap.Member}</p> have additional properties
         * that aren't explicitly declared.  The most common offenders
         * are the (@link net.sf.mondrianart.mondrian.olap.Measure} implementations, which
