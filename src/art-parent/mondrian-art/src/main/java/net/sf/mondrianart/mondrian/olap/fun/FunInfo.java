...
/**
 * Support class for the {@link net.sf.mondrianart.mondrian.tui.CmdRunner} allowing one to view
...
public class FunInfo implements Comparable<FunInfo> {
     ...
     * as those returned by {@link net.sf.mondrianart.mondrian.olap.Exp#getCategory()}.
     */
     ...
     * as those returned by {@link net.sf.mondrianart.mondrian.olap.Exp#getCategory()}. The
