 ...
 * {@link net.sf.mondrianart.mondrian.spi.DialectFactory} for more details.</p>
 *
 * <h3>Registering dialects</h3>
 *
 * <p>A dialect needs to be registered with the system in order to be used.
 * Call {@link net.sf.mondrianart.mondrian.spi.DialectManager#register(DialectFactory)}
 * to register a dialect factory, or
 * {@link net.sf.mondrianart.mondrian.spi.DialectManager#register(Class)} to register a dialect
 * class.
 *
 ...
 * {@link net.sf.mondrianart.mondrian.spi.impl.JdbcDialectImpl}, to help to make your
...
public interface Dialect {
     ...
     * {@link net.sf.mondrianart.mondrian.spi.Dialect.DatabaseProduct#UNKNOWN} if the database is
     ...
     * {@link net.sf.mondrianart.mondrian.spi.Dialect}.
     *
