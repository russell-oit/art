...
import java.util.*;
 ...
 /**
 * Callback by which a {@link net.sf.mondrianart.mondrian.olap.MondrianServer} finds its
 ...
 * {@link net.sf.mondrianart.mondrian.rolap.RolapConnection connection} parameter. Other
