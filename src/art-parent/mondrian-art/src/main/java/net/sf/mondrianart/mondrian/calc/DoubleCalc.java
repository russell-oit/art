 ...
 * {@link net.sf.mondrianart.mondrian.calc.impl.AbstractDoubleCalc}, but it is not required.
 *
 * @author jhyde
 * @since Sep 27, 2005
 */
public interface DoubleCalc extends Calc {
     ...
     * {@link net.sf.mondrianart.mondrian.olap.fun.FunUtil#DoubleNull} value.
     *
