...
import net.sf.mondrianart.mondrian.rolap.SqlStatement.Type;
...
public class AggregationManager extends RolapAggregationManager {
     ...
     *   Use {@link net.sf.mondrianart.mondrian.olap.MondrianServer#getAggregationManager()}.
     *   To get a server, call
     *   {@link net.sf.mondrianart.mondrian.olap.MondrianServer#forConnection(mondrian.olap.Connection)},
...
*/
    ...
    /**
     * Implementation of {@link net.sf.mondrianart.mondrian.rolap.RolapAggregationManager.PinSet}
