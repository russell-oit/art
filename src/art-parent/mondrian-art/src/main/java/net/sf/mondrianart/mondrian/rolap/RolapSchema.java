...
import net.sf.mondrianart.mondrian.olap.fun.*;
import net.sf.mondrianart.mondrian.olap.type.*;
import net.sf.mondrianart.mondrian.resource.MondrianResource;
import net.sf.mondrianart.mondrian.rolap.aggmatcher.AggTableManager;
import net.sf.mondrianart.mondrian.rolap.aggmatcher.JdbcSchema;
import net.sf.mondrianart.mondrian.spi.CellFormatter;
import net.sf.mondrianart.mondrian.spi.*;
import net.sf.mondrianart.mondrian.spi.MemberFormatter;
import net.sf.mondrianart.mondrian.spi.PropertyFormatter;
import net.sf.mondrianart.mondrian.spi.impl.Scripts;
...
public class RolapSchema implements Schema {
     ...
     * that has
     * {@link net.sf.mondrianart.mondrian.rolap.RolapConnectionProperties#Ignore Ignore}=true.
     */
     ...
     * (see {@link net.sf.mondrianart.mondrian.rolap.RolapConnectionProperties#Ignore}), adds
     ...
     *   The class must implement {@link net.sf.mondrianart.mondrian.spi.UserDefinedFunction}
