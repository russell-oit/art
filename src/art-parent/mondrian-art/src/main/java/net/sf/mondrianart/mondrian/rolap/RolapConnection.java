...
import net.sf.mondrianart.mondrian.parser.MdxParserValidator;
...
import net.sf.mondrianart.mondrian.spi.impl.JndiDataSourceResolver;
...
public class RolapConnection extends ConnectionBase {
     ...
     *
     * <p>Only {@link net.sf.mondrianart.mondrian.rolap.RolapSchema.Pool#get} calls this with
    ...
    /**
     * Returns the instance of the {@link net.sf.mondrianart.mondrian.spi.DataSourceResolver}
     * plugin.
     *
     ...
     * {@link net.sf.mondrianart.mondrian.olap.Util.PropertyList connectInfo}.
     *
