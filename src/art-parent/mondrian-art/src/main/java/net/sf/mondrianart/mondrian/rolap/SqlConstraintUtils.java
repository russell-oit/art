...
import net.sf.mondrianart.mondrian.util.FilteredIterableList;

import java.util.*;

/**
 * Utility class used by implementations of {@link net.sf.mondrianart.mondrian.rolap.sql.SqlConstraint},
 * used to generate constraints into {@link net.sf.mondrianart.mondrian.rolap.sql.SqlQuery}.
 *
 * @author av
 * @since Nov 21, 2005
 */
