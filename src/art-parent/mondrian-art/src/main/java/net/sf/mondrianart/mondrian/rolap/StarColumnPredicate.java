...
public interface StarColumnPredicate extends StarPredicate {
     ...
     * {@link net.sf.mondrianart.mondrian.util.Bug#BugMondrian313Fixed bug MONDRIAN-313} and
     * {@link net.sf.mondrianart.mondrian.util.Bug#BugMondrian314Fixed bug MONDRIAN-314} are fixed.
     */
    StarColumnPredicate cloneWithColumn(RolapStar.Column column);

    /**
     * Returned by
     * {@link net.sf.mondrianart.mondrian.rolap.StarColumnPredicate#intersect},
