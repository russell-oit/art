    ...
    implements Level, Named
{
    ...
    final net.sf.mondrianart.mondrian.olap.Level level;
    ...
    MondrianOlap4jLevel(
        ...
        net.sf.mondrianart.mondrian.olap.Level level)
    {
    ...
    NamedList<Property> getProperties(boolean includeStandard) {
        ...
        for (net.sf.mondrianart.mondrian.olap.Property property : level.getProperties()) {
