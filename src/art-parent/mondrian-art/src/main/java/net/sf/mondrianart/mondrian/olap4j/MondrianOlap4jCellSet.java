...
import net.sf.mondrianart.mondrian.olap.Axis;
import net.sf.mondrianart.mondrian.olap.*;
import net.sf.mondrianart.mondrian.rolap.RolapAxis;
import net.sf.mondrianart.mondrian.rolap.RolapCell;
    ...
    implements CellSet
{
    ...
    void execute() throws OlapException {
        ...
        // initialize axes
        net.sf.mondrianart.mondrian.olap.Axis[] axes = result.getAxes();
