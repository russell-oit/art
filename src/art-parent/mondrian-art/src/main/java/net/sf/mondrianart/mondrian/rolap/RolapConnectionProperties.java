...
public enum RolapConnectionProperties {
    ...
    /**
     * The "Role" property is the name of the {@link net.sf.mondrianart.mondrian.olap.Role role}
     ...
     * {@link net.sf.mondrianart.mondrian.spi.DynamicSchemaProcessor} interface.
    ...
    /**
     * The name of a class implementing the
     * {@link net.sf.mondrianart.mondrian.spi.DataSourceChangeListener} interface.
     ...
     * {@link net.sf.mondrianart.mondrian.olap.Schema#getWarnings}.
     */
    Ignore,
