        ...
        if (argList != null) {
            if (left != null) {
                ...
                return new UnresolvedFunCall(
                    segment.name, Syntax.Method, toExpArray(argList));
            } else {
                // Function syntax: "foo(arg1, arg2)" or "foo()"
                return new UnresolvedFunCall(
                    segment.name, Syntax.Function, toExpArray(argList));
            }
        } else {
            ...
            if (left instanceof Id && !call) {
                ...
                return new UnresolvedFunCall(
                    segment.name, syntax, new Exp[] {left});
            }
        }
    }
  ...
  final public Id.Segment identifier() throws ParseException {
    ...
    case AMP_QUOTED_ID:
      jj_consume_token(AMP_QUOTED_ID);
        {if (true) return new Id.Segment(
            stripQuotes(token.image, "&[", "]", "]]"), Id.Quoting.KEY);}
      break;
    default:
      jj_la1[0] = jj_gen;
      jj_consume_token(-1);
