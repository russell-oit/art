...
import net.sf.mondrianart.mondrian.util.DelegatingInvocationHandler;
...
public class SqlStatement {
     ...
     * the case, move it to {@link net.sf.mondrianart.mondrian.spi.Dialect}.
     *
     ...
     * calls to the result set inside a {@link net.sf.mondrianart.mondrian.rolap.SqlStatement}.
