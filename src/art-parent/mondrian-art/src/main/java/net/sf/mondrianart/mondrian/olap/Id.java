    ...
    implements Cloneable
{
     ...
     * <li>"Store", {@link net.sf.mondrianart.mondrian.olap.Id.Quoting#QUOTED}</li>
     * <li>"USA", {@link net.sf.mondrianart.mondrian.olap.Id.Quoting#UNQUOTED}</li>
     * <li>"New Mexico", {@link net.sf.mondrianart.mondrian.olap.Id.Quoting#QUOTED}</li>
     * <li>"45", {@link net.sf.mondrianart.mondrian.olap.Id.Quoting#KEY}</li>
     * </ul>
     */
