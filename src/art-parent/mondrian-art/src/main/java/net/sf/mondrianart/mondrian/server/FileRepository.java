...
import net.sf.mondrianart.mondrian.olap4j.MondrianOlap4jDriver;
import net.sf.mondrianart.mondrian.rolap.*;
import net.sf.mondrianart.mondrian.spi.CatalogLocator;
import net.sf.mondrianart.mondrian.tui.XmlaSupport;
import net.sf.mondrianart.mondrian.util.LockBox;
import net.sf.mondrianart.mondrian.xmla.DataSourcesConfig;
...
/**
 * Implementation of {@link net.sf.mondrianart.mondrian.server.Repository} that reads
...
public class FileRepository implements Repository {
    ...
    private static final ScheduledExecutorService executorService =
        Util.getScheduledExecutorService(
            1,
            "net.sf.mondrianart.mondrian.server.DynamicContentFinder$executorService");
