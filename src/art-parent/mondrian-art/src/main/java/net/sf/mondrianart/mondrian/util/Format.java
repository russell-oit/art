...
public class Format {
    ...
    static class NumericFormat extends JavaFormat
    {
        ...
        void format(long n, StringBuilder buf)
        {
            net.sf.mondrianart.mondrian.util.Format.FloatingDecimal fd =
                new net.sf.mondrianart.mondrian.util.Format.FloatingDecimal(n);
            fd.shift(decimalShift);
            String s = fd.toJavaFormatString(
                zeroesLeftOfPoint,
                locale.decimalPlaceholder,
...
static class FloatingDecimal {
        ...
        ArrayStack<Integer> thousandSeparatorPositions)
    {
        ...
        int resultLen =
            10
            + (Math.abs(decExponent) + minDigitsLeftOfDecimal) * 4 / 3
            + maxDigitsRightOfDecimal;
        ...
        ArrayStack<Integer> thousandSeparatorPositions)
    {
        ...
        if (isExceptional) {
            ...
            System.arraycopy(
                digits, 0, digits2, wholeDigits - decExponent, nDigits);
