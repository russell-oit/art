...
import net.sf.mondrianart.mondrian.olap.fun.VisualTotalsFunDef.VisualTotalMember;
import net.sf.mondrianart.mondrian.olap.type.ScalarType;
...
import net.sf.mondrianart.mondrian.rolap.agg.CellRequestQuantumExceededException;
...
public class RolapResult extends ResultBase {
     ...
     * as a parameter and uses it to get the {@link net.sf.mondrianart.mondrian.util.Format}
