 ...
 *
 * <p>The property
 * {@link net.sf.mondrianart.mondrian.olap.MondrianProperties#DataSourceResolverClass} determines
 * which class to use. The default implementation is
 * {@link net.sf.mondrianart.mondrian.spi.impl.JndiDataSourceResolver}.
 *
 * @author jhyde
 */
