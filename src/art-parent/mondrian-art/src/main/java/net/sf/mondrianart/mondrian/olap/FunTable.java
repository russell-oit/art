...
import net.sf.mondrianart.mondrian.olap.fun.FunInfo;
...
public interface FunTable {
    ...
    /**
     * Returns a list of {@link net.sf.mondrianart.mondrian.olap.fun.Resolver} objects.
     */
    ...
    /**
     * Returns a list of {@link net.sf.mondrianart.mondrian.olap.fun.FunInfo} objects.
     */
     ...
     *
     * <p>An implementation of {@link net.sf.mondrianart.mondrian.olap.FunTable} must register all
     * of its functions and operators by making callbacks during its
     * {@link net.sf.mondrianart.mondrian.olap.FunTable#defineFunctions(mondrian.olap.FunTable.Builder)}
     * method.
     */
