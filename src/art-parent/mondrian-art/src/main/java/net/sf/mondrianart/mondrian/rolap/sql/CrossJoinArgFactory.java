...
// All Rights Reserved.
*/
package net.sf.mondrianart.mondrian.rolap.sql;
...
public class CrossJoinArgFactory {
     ...
     *
     * @return an {@link net.sf.mondrianart.mondrian.rolap.sql.CrossJoinArg} instance describing the enumeration,
     ...
     *
     * @return an {@link net.sf.mondrianart.mondrian.rolap.sql.CrossJoinArg} instance describing the member.children
     ...
     *
     * @return an {@link net.sf.mondrianart.mondrian.rolap.sql.CrossJoinArg} instance describing the Level.members
     *         function, or null if <code>fun</code> represents something else.
     */
     ...
     *
     * @return an {@link net.sf.mondrianart.mondrian.rolap.sql.CrossJoinArg} instance describing the Descendants
     *         function, or null if <code>fun</code> represents something else.
     */
        ...
        boolean exclude)
    {
        ...
        if (!(currentMemberArgType
            instanceof net.sf.mondrianart.mondrian.olap.type.DimensionType
