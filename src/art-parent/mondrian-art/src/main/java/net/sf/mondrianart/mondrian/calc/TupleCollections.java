...
public final class TupleCollections {
     ...
     * {@link net.sf.mondrianart.mondrian.calc.TupleIterable#tupleIterator()} for a
     ...
     * {@link net.sf.mondrianart.mondrian.calc.TupleList#slice(int)}.
     *
    ...
    /**
     * Converts a {@link net.sf.mondrianart.mondrian.calc.TupleIterable} to an old-style iterable that
    ...
    /**
     * Converts a {@link net.sf.mondrianart.mondrian.calc.TupleList} to an old-style list of member
     * arrays.
     *
     ...
     * {@link net.sf.mondrianart.mondrian.calc.TupleList}.
     *
