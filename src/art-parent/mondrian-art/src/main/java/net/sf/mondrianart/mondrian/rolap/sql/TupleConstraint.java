...
/**
 * Restricts the SQL result of {@link net.sf.mondrianart.mondrian.rolap.TupleReader}. This is also
 * used by
 * {@link net.sf.mondrianart.mondrian.rolap.SqlMemberSource#getMembersInLevel(RolapLevel, int, int, TupleConstraint)}.
 *
