...
public class Property extends EnumeratedValues.BasicValue {
     ...
     * use {@link net.sf.mondrianart.mondrian.olap.SchemaReader#getParentChildContributingChildren}
     */
	@Deprecated
     ...
     *
     * <p>The class must implement the {@link net.sf.mondrianart.mondrian.spi.CellFormatter}
     * interface.
     *
