...
import net.sf.mondrianart.mondrian.olap.fun.ParameterFunDef;
...
import net.sf.mondrianart.mondrian.util.ArrayStack;
...
public class Query extends QueryPart {
    ...
    /**
     * Implementation of {@link net.sf.mondrianart.mondrian.olap.Validator} that works within a
     * particular query.
     *
     ...
     * the majority of the code in {@link net.sf.mondrianart.mondrian.olap.ValidatorImpl}, the
