...
import net.sf.mondrianart.mondrian.rolap.sql.SqlConstraint;
import net.sf.mondrianart.mondrian.util.Pair;

/**
 * Uses a {@link net.sf.mondrianart.mondrian.rolap.cache.SmartCache} to store lists of members,
 * where the key depends on a {@link net.sf.mondrianart.mondrian.rolap.sql.SqlConstraint}.
 *
 * <p>Example 1:
 *
 * <pre>
 ...
 * cacheKey of the {@link net.sf.mondrianart.mondrian.rolap.sql.SqlConstraint}.
 *
