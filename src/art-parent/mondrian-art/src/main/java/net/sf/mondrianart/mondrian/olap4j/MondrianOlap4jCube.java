...
{
    final net.sf.mondrianart.mondrian.olap.Cube cube;
    ...
    public NamedList<Dimension> getDimensions() {
        ...
        final net.sf.mondrianart.mondrian.olap.SchemaReader schemaReader =
            ...
            .withLocus();
        for (net.sf.mondrianart.mondrian.olap.Dimension dimension
    ...
    public NamedList<Hierarchy> getHierarchies() {
        ...
        for (net.sf.mondrianart.mondrian.olap.Dimension dimension
            : schemaReader.getCubeDimensions(cube))
        {
            for (net.sf.mondrianart.mondrian.olap.Hierarchy hierarchy
    ...
    public List<Measure> getMeasures() {
        ...
        try {
            ...
            List<net.sf.mondrianart.mondrian.olap.Member> levelMembers =
                schemaReader.getLevelMembers(
                    measuresLevel.level,
                    true);
            for (net.sf.mondrianart.mondrian.olap.Member member : levelMembers) {
                measures.add(
    ...
    public NamedList<NamedSet> getSets() {
        ...
        final MondrianOlap4jConnection olap4jConnection =
            olap4jSchema.olap4jCatalog.olap4jDatabaseMetaData.olap4jConnection;
        for (net.sf.mondrianart.mondrian.olap.NamedSet namedSet : cube.getNamedSets()) {
    ...
    private MondrianOlap4jMember lookupMember(
        ...
        List<IdentifierSegment> nameParts)
    {
        final List<net.sf.mondrianart.mondrian.olap.Id.Segment> segmentList =
            new ArrayList<net.sf.mondrianart.mondrian.olap.Id.Segment>();
        for (IdentifierSegment namePart : nameParts) {
            segmentList.add(Util.convert(namePart));
        }
        final net.sf.mondrianart.mondrian.olap.Member member =
    ...
    private void addDescendants(
        ...
        boolean recurse)
    {
        for (net.sf.mondrianart.mondrian.olap.Member m
