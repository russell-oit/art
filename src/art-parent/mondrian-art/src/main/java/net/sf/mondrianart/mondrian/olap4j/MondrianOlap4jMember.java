...
import net.sf.mondrianart.mondrian.rolap.RolapMeasure;
    ...
    implements Member, Named
{
    ...
    MondrianOlap4jMember(
        ...
        net.sf.mondrianart.mondrian.olap.Member mondrianMember)
    {
    ...
    {
        final List<net.sf.mondrianart.mondrian.olap.Member> children =
        ...
        return new AbstractNamedList<MondrianOlap4jMember>() {
            public String getName(Object o) {
				if(o instanceof MondrianOlap4jMember){
					MondrianOlap4jMember member=(MondrianOlap4jMember) o;
    ...
    public MondrianOlap4jMember getParentMember() {
        final net.sf.mondrianart.mondrian.olap.Member parentMember = member.getParentMember();
    ...
    public Member getDataMember() {
        final net.sf.mondrianart.mondrian.olap.Member dataMember = member.getDataMember();
        if (dataMember == null) {
            return null;
        }
    ...
    public boolean isVisible() {
        return (Boolean) member.getPropertyValue(
            net.sf.mondrianart.mondrian.olap.Property.VISIBLE.getName());
    }
