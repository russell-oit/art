 ...
 * <dl>
 *
 * <dt>Obsolete {@link net.sf.mondrianart.mondrian.olap.Id.Segment}</dt>
 * <dd>Replace it by {@link org.olap4j.mdx.IdentifierSegment}. Likewise
 * {@link net.sf.mondrianart.mondrian.olap.Id.Quoting} with {@link org.olap4j.mdx.Quoting}.
...
public class Bug {
     ...
     * {@link net.sf.mondrianart.mondrian.olap.MondrianProperties#SsasCompatibleNaming},
     ...
     * {@link net.sf.mondrianart.mondrian.spi.Dialect.DatabaseProduct#LUCIDDB} and we wish to
     * avoid slow tests.
     *
    ...
    public static boolean avoidSlowTestOnLucidDB(Dialect dialect) {
        return
            ...
            && !Logger.getLogger("net.sf.mondrianart.mondrian.test.PerformanceTest")
                .isDebugEnabled();
    }
}
