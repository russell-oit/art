 ...
 * {@link net.sf.mondrianart.mondrian.rolap.agg.SparseSegmentDataset} to store values within
 * aggregations.
 *
 ...
 * {@link net.sf.mondrianart.mondrian.rolap.CellKey.Generator#newCellKey(int[])} method.
 *
 * @author jhyde
