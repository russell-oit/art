...
// All Rights Reserved.
*/
package net.sf.mondrianart.mondrian.xmla.impl;

import net.sf.mondrianart.mondrian.olap.MondrianServer;
import net.sf.mondrianart.mondrian.olap.Util;
import net.sf.mondrianart.mondrian.server.RepositoryContentFinder;
import net.sf.mondrianart.mondrian.server.UrlRepositoryContentFinder;
...
/**
 * Extension to {@link net.sf.mondrianart.mondrian.xmla.XmlaServlet} that instantiates a
 * Mondrian engine.
 *
 * @author jhyde
 */
