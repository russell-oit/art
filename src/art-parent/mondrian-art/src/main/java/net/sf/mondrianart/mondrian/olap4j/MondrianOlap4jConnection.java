...
import net.sf.mondrianart.mondrian.mdx.*;
import net.sf.mondrianart.mondrian.olap.*;
import net.sf.mondrianart.mondrian.olap.Member;
import net.sf.mondrianart.mondrian.olap.fun.MondrianEvaluationException;
import net.sf.mondrianart.mondrian.rolap.*;
...
abstract class MondrianOlap4jConnection implements OlapConnection {
     ...
     */
    final Map<net.sf.mondrianart.mondrian.olap.Schema, MondrianOlap4jSchema> schemaMap =
        new HashMap<net.sf.mondrianart.mondrian.olap.Schema, MondrianOlap4jSchema>();
     ...
     * See {@link net.sf.mondrianart.mondrian.olap4j.MondrianOlap4jDriver} for more details.
     *
        ...
        throws SQLException
    {
        ...
        this.mondrianConnection =
            (RolapConnection) net.sf.mondrianart.mondrian.olap.DriverManager
    ...
    MondrianOlap4jCube toOlap4j(net.sf.mondrianart.mondrian.olap.Cube cube) {
        MondrianOlap4jSchema schema = toOlap4j(cube.getSchema());
        return new MondrianOlap4jCube(cube, schema);
    }

    MondrianOlap4jDimension toOlap4j(net.sf.mondrianart.mondrian.olap.Dimension dimension) {
    ...
    synchronized MondrianOlap4jSchema toOlap4j(
        net.sf.mondrianart.mondrian.olap.Schema schema)
    {
    ...
    Type toOlap4j(net.sf.mondrianart.mondrian.olap.type.Type type) {
        if (type instanceof net.sf.mondrianart.mondrian.olap.type.BooleanType) {
            return new BooleanType();
        } else if (type instanceof net.sf.mondrianart.mondrian.olap.type.CubeType) {
            final net.sf.mondrianart.mondrian.olap.Cube mondrianCube =
                ((net.sf.mondrianart.mondrian.olap.type.CubeType) type).getCube();
            return new CubeType(toOlap4j(mondrianCube));
        } else if (type instanceof net.sf.mondrianart.mondrian.olap.type.DecimalType) {
            net.sf.mondrianart.mondrian.olap.type.DecimalType decimalType =
                (net.sf.mondrianart.mondrian.olap.type.DecimalType) type;
            return new DecimalType(
                decimalType.getPrecision(),
                decimalType.getScale());
        } else if (type instanceof net.sf.mondrianart.mondrian.olap.type.DimensionType) {
            net.sf.mondrianart.mondrian.olap.type.DimensionType dimensionType =
                (net.sf.mondrianart.mondrian.olap.type.DimensionType) type;
            return new DimensionType(
                toOlap4j(dimensionType.getDimension()));
        } else if (type instanceof net.sf.mondrianart.mondrian.olap.type.HierarchyType) {
            return new BooleanType();
        } else if (type instanceof net.sf.mondrianart.mondrian.olap.type.LevelType) {
            return new BooleanType();
        } else if (type instanceof net.sf.mondrianart.mondrian.olap.type.MemberType) {
            final net.sf.mondrianart.mondrian.olap.type.MemberType memberType =
                (net.sf.mondrianart.mondrian.olap.type.MemberType) type;
        ...
        } else if (type instanceof net.sf.mondrianart.mondrian.olap.type.NullType) {
            return new NullType();
        } else if (type instanceof net.sf.mondrianart.mondrian.olap.type.NumericType) {
            return new NumericType();
        } else if (type instanceof net.sf.mondrianart.mondrian.olap.type.SetType) {
            final net.sf.mondrianart.mondrian.olap.type.SetType setType =
                (net.sf.mondrianart.mondrian.olap.type.SetType) type;
            return new SetType(toOlap4j(setType.getElementType()));
        } else if (type instanceof net.sf.mondrianart.mondrian.olap.type.StringType) {
            return new StringType();
        } else if (type instanceof net.sf.mondrianart.mondrian.olap.type.TupleType) {
            net.sf.mondrianart.mondrian.olap.type.TupleType tupleType =
                (net.sf.mondrianart.mondrian.olap.type.TupleType) type;
            final Type[] types = toOlap4j(tupleType.elementTypes);
            return new TupleType(types);
        } else if (type instanceof net.sf.mondrianart.mondrian.olap.type.SymbolType) {
    ...
    MondrianOlap4jMember toOlap4j(net.sf.mondrianart.mondrian.olap.Member member) {
        if (member == null) {
            return null;
        }
    ...
    MondrianOlap4jLevel toOlap4j(net.sf.mondrianart.mondrian.olap.Level level) {
        if (level == null) {
            return null;
        }
    ...
    MondrianOlap4jHierarchy toOlap4j(net.sf.mondrianart.mondrian.olap.Hierarchy hierarchy) {
        if (hierarchy == null) {
            return null;
        }
    ...
    Type[] toOlap4j(net.sf.mondrianart.mondrian.olap.type.Type[] mondrianTypes) {
        ...
        final List<Member> memberList)
    {
        return new AbstractNamedList<MondrianOlap4jMember>() {
            public String getName(Object o) {
				if(o instanceof MondrianOlap4jMember){
					MondrianOlap4jMember olap4jMember=(MondrianOlap4jMember) o;
    ...
    MondrianOlap4jNamedSet toOlap4j(
        net.sf.mondrianart.mondrian.olap.Cube cube,
        net.sf.mondrianart.mondrian.olap.NamedSet namedSet)
    {
        if (namedSet == null) {
            return null;
        }
    ...
    static class Helper {
            ...
            String msg, Throwable cause)
        {
            ...
            assert !net.sf.mondrianart.mondrian.util.Bug.olap4jUpgrade(
    ...
    private static class MondrianToOlap4jNodeConverter {
        ...
        private org.olap4j.mdx.Syntax toOlap4j(net.sf.mondrianart.mondrian.olap.Syntax syntax) {
