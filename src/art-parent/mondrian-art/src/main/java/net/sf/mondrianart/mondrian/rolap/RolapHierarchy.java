...
import net.sf.mondrianart.mondrian.olap.Role.HierarchyAccess;
...
import net.sf.mondrianart.mondrian.rolap.RestrictedMemberReader.MultiCardinalityDefaultMember;
...
import net.sf.mondrianart.mondrian.util.UnionIterator;
...
public class RolapHierarchy extends HierarchyBase {
    ...
    MemberReader createMemberReader(Role role) {
        ...
        case CUSTOM:
            ...
            case PARTIAL:
                Type memberType1 =
                    new net.sf.mondrianart.mondrian.olap.type.MemberType(
                        getDimension(),
                        this,
                        null,
                        null);
     ...
     * {@link net.sf.mondrianart.mondrian.olap.MondrianDef.Closure} element
     ...
     * As part of {@link net.sf.mondrianart.mondrian.util.Bug#BugSegregateRolapCubeMemberFixed},
     * maybe make {@link net.sf.mondrianart.mondrian.rolap.RolapCubeMember} an interface.
     *
