...
import net.sf.mondrianart.mondrian.olap.fun.SetFunDef;
import net.sf.mondrianart.mondrian.resource.MondrianResource;
import net.sf.mondrianart.mondrian.rolap.agg.*;
...
/**
 * <code>RolapCell</code> implements {@link net.sf.mondrianart.mondrian.olap.Cell} within a
 * {@link RolapResult}.
 */
public class RolapCell implements Cell {
    /**
     * @see mondrian.util.Bug#olap4jUpgrade Use
     * {@link net.sf.mondrianart.mondrian.xmla.XmlaConstants}.ActionType.DRILLTHROUGH when present
     */
