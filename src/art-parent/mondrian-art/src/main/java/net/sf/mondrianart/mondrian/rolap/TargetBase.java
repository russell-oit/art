 ...
 * {@link net.sf.mondrianart.mondrian.rolap.HighCardSqlTupleReader} and
 * {@link net.sf.mondrianart.mondrian.rolap.SqlTupleReader}.
 *
 * <p>Keeps track of target levels and constraints for adding to the SQL query.
 * The real work is done in the extending classes,
 * {@link Target} and
 * {@link net.sf.mondrianart.mondrian.rolap.SqlTupleReader.Target}.
 *
