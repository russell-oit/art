...
abstract class Rowset implements XmlaConstants {
     ...
     * {@link net.sf.mondrianart.mondrian.xmla.Rowset.Row} object.
     *
     * @param row Row
     ...
     *
     * <p>A condition is a {@link net.sf.mondrianart.mondrian.olap.Util.Functor1} whose return
     * type is boolean.
     *
     ...
     * {@link net.sf.mondrianart.mondrian.xmla.Rowset.Row}.
     */
