...
import net.sf.mondrianart.mondrian.olap.fun.NonEmptyCrossJoinFunDef;
import net.sf.mondrianart.mondrian.rolap.sql.*;

import java.util.*;

/**
 * Creates a {@link net.sf.mondrianart.mondrian.olap.NativeEvaluator} that evaluates NON EMPTY
