...
// All Rights Reserved.
*/
package net.sf.mondrianart.mondrian.olap.fun.vba;

import net.sf.mondrianart.mondrian.olap.InvalidArgumentException;
import net.sf.mondrianart.mondrian.olap.fun.JavaFunDef;

import static net.sf.mondrianart.mondrian.olap.fun.JavaFunDef.Description;
import static net.sf.mondrianart.mondrian.olap.fun.JavaFunDef.FunctionName;
