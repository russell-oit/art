...
public class LogHandler {
  ...
  private Map<String, File> configs = new TreeMap<>();
  ...
  private void createDefConfig(String name) throws IOException {
    String resName = "/net/sf/wcfart/wcf/log/" + name + ".properties";
   ...
   * @return null or the label of the config name
   */
  public String getLabel(String configName) {
    return labels.get(configName);
  }
   ...
   * which level is set for the root logger. May be empty 
	 * @return which level is set for the root logger. May be empty
   */
