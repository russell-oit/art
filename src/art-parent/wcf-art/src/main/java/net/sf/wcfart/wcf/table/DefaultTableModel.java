...
public class DefaultTableModel extends ArrayList<DefaultTableModel> implements TableModel {
  ...
  public DefaultTableModel(Collection<DefaultTableModel> rows, String[] columnTitles) {
    this.addAll(rows);
