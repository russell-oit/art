...
public class CategorySupport implements Category {
  ...
  /**
   * @see net.sf.wcfart.wcf.catedit.Category#addItem(Item)
   */
  ...
  /**
   * @see net.sf.wcfart.wcf.catedit.Category#changeOrder(List)
   */
  public void changeOrder(List<Item> items) {
    this.items = items;
  }

  /**
   * @see net.sf.wcfart.wcf.catedit.Category#removeItem(Item)
   */
