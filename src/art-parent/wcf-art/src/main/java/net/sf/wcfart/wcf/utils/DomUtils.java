...
public class DomUtils {
   ...
   */
  public static List<Element> getChildElemsByTagName(Element parent, String tagName) {
    ArrayList<Element> retVec = new ArrayList<>();
   ...
   */
  public static List<Node> getChildNodesExceptAttributes(Node parent) {
    ArrayList<Node> retVec = new ArrayList<>();
    NodeList children = parent.getChildNodes();
    for (int i = 0; i < children.getLength(); ++i) {
  ...
  public static void removeChildElements(Element parent) {
    List<Node> v = getChildElements(parent);
    Iterator<Node> en = v.iterator();
    while (en.hasNext())
      parent.removeChild(en.next());
  }
  ...
  public static void removeChildNodesExceptAttributes(Element parent) {
    List<Node> v = getChildNodesExceptAttributes(parent);
    Iterator<Node> en = v.iterator();
    while (en.hasNext())
      parent.removeChild(en.next());
  }
