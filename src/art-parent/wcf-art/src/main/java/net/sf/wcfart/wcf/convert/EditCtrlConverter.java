...
import net.sf.wcfart.wcf.ui.EditCtrl;
import net.sf.wcfart.wcf.ui.TypedCtrl;
import net.sf.wcfart.wcf.utils.XoplonNS;
import org.apache.commons.fileupload.FileItem;

/**
 * converts user input for a Edit control
 * @see net.sf.wcfart.wcf.ui.EditCtrl
 * @author av
 */
public class EditCtrlConverter extends NodeConverterBase {
   ...
   */
  public void convert(Formatter formatter, Map<String, String[]> param,  Map<String, FileItem[]> fileSource, Element element, Object bean)
    ...
    String[] inputValue = param.get(id);
