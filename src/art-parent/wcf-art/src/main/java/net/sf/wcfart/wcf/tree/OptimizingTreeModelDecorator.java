...
public class OptimizingTreeModelDecorator extends TreeModelDecorator {
   ...
   * @param decoree the tree model to decorate
   ...
   * @param filter accepted nodes are considered "significant"
   */
  public OptimizingTreeModelDecorator(NodeFilter filter, TreeModel decoree, Comparator<? super Object> nodeComparator) {
