...
import net.sf.wcfart.wcf.selection.Unselectable;
...
public class GroupingTreeModelDecorator extends TreeModelDecorator {
  ...
  private Map<Object, Object> mapChild2Parent;
  private Map<Object, Object[]> mapParent2Children;
   ...
   * @param limit number of children that will not divided into groups
   */
  public GroupingTreeModelDecorator(Comparator<Object> nodeComparator, LabelProvider labelProvider,
      TreeModel decoree, int limit) {
    super(decoree);
    Comparator<Object> comp = new GroupComparator(nodeComparator);
    this.mapChild2Parent = new TreeMap<>(comp);
    this.mapParent2Children = new TreeMap<>(comp);
    initialize(labelProvider, limit);
  }

  class GroupComparator implements Comparator<Object> {
    Comparator<Object> nodeComparator;

    public GroupComparator(Comparator<Object> nodeComparator) {
  ...
  private void invalidateSubtree(Object parent) {
    Object[] children = mapParent2Children.remove(parent);
    if (children != null) {
  ...
  public class Group implements Unselectable, Comparable<Group> {
  ...
  public Object[] getRoots() {
    Object[] roots = mapParent2Children.get(NULL);
    if (roots != null)
      return roots;
  ...
  public Object[] getChildren(Object node) {
    Object[] children = mapParent2Children.get(node);
    if (children != null)
      return children;
