...
public class RadioButtonConverter extends BooleanConverter {
  ...
  /**
   * @see net.sf.wcfart.wcf.convert.BooleanConverter#isSelected(Element, Map)
   */
  public int isSelected(Element elem, Map<String, String[]> params) {
    ...
    String[] values = params.get(groupId);
    if (values == null)
      return FALSE;
