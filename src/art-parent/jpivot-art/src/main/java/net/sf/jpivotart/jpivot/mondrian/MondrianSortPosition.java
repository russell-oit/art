...
public class MondrianSortPosition implements Comparable {
  ...
  public int index;
  private net.sf.mondrianart.mondrian.olap.Member[] posMembers;

  /** c'tor
   */
  public MondrianSortPosition(int index, net.sf.mondrianart.mondrian.olap.Member[] posMembers) {
    this.index = index;
  ...
  public int compareTo(Object o) {
    ...
    DimensionLoop : for (int i = 0; i < this.posMembers.length; i++) {
      net.sf.mondrianart.mondrian.olap.Member m1 = this.posMembers[i];
      net.sf.mondrianart.mondrian.olap.Member m2 = other.posMembers[i];
      if (m1.equals(m2))
