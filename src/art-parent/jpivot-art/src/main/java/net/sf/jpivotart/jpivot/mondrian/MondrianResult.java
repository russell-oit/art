...
import net.sf.jpivotart.jpivot.olap.model.impl.FormatStringParser;
import net.sf.jpivotart.jpivot.olap.query.ResultBase;
...
import net.sf.mondrianart.mondrian.olap.ResourceLimitExceededException;
...
public class MondrianResult extends ResultBase {
  ...
  private net.sf.mondrianart.mondrian.olap.Result monResult = null;
  private int[] posize;
   ...
   */
  protected MondrianResult(net.sf.mondrianart.mondrian.olap.Result monResult, MondrianModel model)
  ...
  private void initData() throws ResultLimitExceededException {
    ...
    net.sf.mondrianart.mondrian.olap.Axis[] monAxes = monResult.getAxes();
    ...
    net.sf.mondrianart.mondrian.olap.Axis monSlicer = monResult.getSlicerAxis();
    ...
    for (int i = 0; i < nCells; i++) {
      net.sf.mondrianart.mondrian.olap.Cell monCell = monResult.getCell(iar);
