...
import net.sf.jpivotart.jpivot.table.span.PropertyConfig;
...
import net.sf.jpivotart.jpivot.table.span.SpanConfigSupport;
...
public abstract class AxisBuilderSupport extends PartBuilderSupport implements AxisBuilder,
  ...
  /**
   * @see net.sf.jpivotart.jpivot.table.AxisBuilder#getAxisConfig()
   */
