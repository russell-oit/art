...
import net.sf.jpivotart.jpivot.olap.model.PropertyHolder;
import net.sf.jpivotart.jpivot.olap.model.Visitable;
import net.sf.jpivotart.jpivot.olap.model.VisitorSupportStrict;
import net.sf.jpivotart.jpivot.table.span.PropertyHeading;
import net.sf.jpivotart.jpivot.table.span.PropertyUtils;
import net.sf.jpivotart.jpivot.table.span.Span;
import net.sf.jpivotart.jpivot.table.span.SpanVisitor;
