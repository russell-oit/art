...
public class XMLA_MemberProperties extends ExtensionSupport implements MemberProperties {
   ...
   * @see net.sf.jpivotart.jpivot.olap.navi.MemberProperties#getMemberPropertyMetas
   */
   ...
   * @see net.sf.jpivotart.jpivot.olap.navi.MemberProperties#isLevelScope()
   */
   ...
   * @see net.sf.jpivotart.jpivot.olap.navi.MemberProperties#getPropertyScope
   */
