...
public class XMLA_QuaxUti implements QuaxUti {
  ...
  /**
   * @return funcall name
   * @see net.sf.jpivotart.jpivot.olap.query.QuaxUti#funCallName(java.lang.Object)
   */
   ...
   * @see net.sf.jpivotart.jpivot.olap.query.QuaxUti#objForDim(net.sf.jpivotart.jpivot.olap.model.Dimension)
   */
  ...
  public net.sf.mondrianart.mondrian.olap.Exp toExp(Object o) {
    return (net.sf.mondrianart.mondrian.olap.Exp) o;
  }
