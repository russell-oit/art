...
import net.sf.jpivotart.jpivot.olap.model.OlapDiscoverer;
import net.sf.jpivotart.jpivot.olap.model.OlapException;
import net.sf.jpivotart.jpivot.olap.model.OlapItem;
...
import net.sf.jpivotart.jpivot.olap.query.QuaxBean;
...
public class XMLA_Model extends MdxOlapModel implements OlapModel, QueryAdapter.QueryAdapterHolder {
   ...
   * @see net.sf.jpivotart.jpivot.olap.query.MdxOlapModel#getCurrentMdx()
   */
   ...
   * @param state state bean to be restored
   */
   ...
   * @return whether a member is in the formulas
   */
