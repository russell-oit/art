...
public class DrillExpandPositionExt extends ExtensionSupport implements DrillExpandPosition {
  ...
  /**
   * @see net.sf.jpivotart.jpivot.olap.navi.DrillExpandPosition#canExpand(Position, Member)
  ...
  /**
   * @see net.sf.jpivotart.jpivot.olap.navi.DrillExpandPosition#canCollapse(Position, Member)
   * @param position position to be expanded
   * @return true if the member can be expanded
   */
  ...
  /**
   * @see net.sf.jpivotart.jpivot.olap.navi.DrillExpandPosition#expand(Position, Member)
   * @param position position to be expanded
   * @param member member to be expanded
   */
