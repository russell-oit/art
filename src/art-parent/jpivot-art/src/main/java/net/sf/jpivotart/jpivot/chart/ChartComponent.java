 ...
 * ====================================================================
 */
package net.sf.jpivotart.jpivot.chart;
...
import net.sf.wcfart.wcf.table.TableComponent;
...
//	}
			...
			if ( canDrillThrough(cell) ) {
				...
				if (tc instanceof EditableTableComponent) {
					tableColumns = ((EditableTableComponent) tc).getTableComp()
							.getTableColumns();
				} else if (tc instanceof TableComponent) {
					tableColumns = ((TableComponent) tc)
							.getTableColumns();
				}
	 ...
	 * @param cell
	 * @return a DrillThroughTableModel for the drill through
	 */
