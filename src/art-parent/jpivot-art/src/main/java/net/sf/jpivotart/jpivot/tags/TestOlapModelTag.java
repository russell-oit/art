...
import net.sf.jpivotart.jpivot.test.olap.TestAxis;
import net.sf.jpivotart.jpivot.test.olap.TestDimension;
import net.sf.jpivotart.jpivot.test.olap.TestOlapModel;
import net.sf.jpivotart.jpivot.test.olap.TestOlapModelUtils;
...
public class TestOlapModelTag extends OlapModelTag {
  ...
  protected URL getDefaultConfig() {
    return getClass().getResource("/net/sf/jpivotart/jpivot/test/olap/config.xml");
  }
