...
import net.sf.jpivotart.jpivot.olap.navi.CalcSet;
...
public class Quax {
   ...
   * @return drillup expression for dimension
   */
   ...
   *          set funcall
   * @param member
   * @return whether member is in set defined by funcall
   */
