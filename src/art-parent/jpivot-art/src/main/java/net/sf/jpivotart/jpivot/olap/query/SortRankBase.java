...
import net.sf.jpivotart.jpivot.olap.query.QueryAdapter.QueryAdapterHolder;
...
public abstract class SortRankBase
  ...
  protected int sortMode = SortRank.ASC;
  ...
  /**
   * @see net.sf.jpivotart.jpivot.olap.navi.SortRank#getTopBottomCount()
  ...
  /**
   * @see net.sf.jpivotart.jpivot.olap.navi.SortRank#setTopBottomCount(int)
   * @param topBottomCount top/bottom count
   */
  ...
  /**
   * @see net.sf.jpivotart.jpivot.olap.navi.SortRank#getSortMode()
  ...
  /**
   * @see net.sf.jpivotart.jpivot.olap.navi.SortRank#setSortMode(int)
   * @param sortMode mode (ASC,DESC,BASC,BDESC)
   */
  ...
  /**
   * @see net.sf.jpivotart.jpivot.olap.navi.SortRank#isCurrentSorting(Position)
  ...
  /**
   * @see net.sf.jpivotart.jpivot.olap.navi.SortRank#sort(Axis, Position)
