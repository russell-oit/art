...
public interface QuaxUti {
   ...
   * @param oMember
   * @return the children of a member object
   */
   ...
   * In particular, adds expression wrappers ({@link net.sf.mondrianart.mondrian.mdx.MemberExpr},
