...
public class DrillExpandMemberUI extends DrillExpandUI {
  ...
  /**
   * @see net.sf.jpivotart.jpivot.table.navi.DrillExpandUI#canExpand(Span)
   */
  ...
  /**
   * @see net.sf.jpivotart.jpivot.table.navi.DrillExpandUI#expand(Span)
   */
  ...
  /**
   * @see net.sf.jpivotart.jpivot.table.navi.DrillExpandUI#canCollapse(Span)
   */
  ...
  /**
   * @see net.sf.jpivotart.jpivot.table.navi.DrillExpandUI#collapse(Span)
   */
