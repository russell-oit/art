...
import net.sf.jpivotart.jpivot.table.AxisConfig;
import net.sf.jpivotart.jpivot.table.ColumnAxisConfig;
import net.sf.jpivotart.jpivot.table.RowAxisConfig;
