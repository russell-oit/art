...
import net.sf.jpivotart.jpivot.olap.model.QueryResultHandler;
...
import net.sf.jpivotart.jpivot.xmla.XMLA_PropValAssign.ValAssign;
...
/**
 * @param drillHeader The drillHeaders to set.
 */
