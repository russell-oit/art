...
import net.sf.jpivotart.jpivot.olap.mdxparse.CompoundId;
import net.sf.jpivotart.jpivot.olap.mdxparse.Exp;
import net.sf.jpivotart.jpivot.olap.mdxparse.ExpVisitor;
...
public class XMLA_Dimension implements Dimension, Exp, MDXElement {
  ...
  /**
   * @see net.sf.jpivotart.jpivot.olap.model.Dimension#isMeasure()
   */
  ...
  /**
   * @see net.sf.jpivotart.jpivot.olap.model.Dimension#isTime()
   */
  ...
  /**
    ...
    * @see net.sf.jpivotart.jpivot.olap.mdxparse.Exp#toMdx()
    */
  public String toMdx() {
    return uniqueName;
  }
  ...
  /**
   * @see net.sf.jpivotart.jpivot.olap.mdxparse.Exp#clone()
   * probably not needed
   */
  public Object clone() {
