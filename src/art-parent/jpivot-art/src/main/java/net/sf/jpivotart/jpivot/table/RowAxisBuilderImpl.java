...
import net.sf.jpivotart.jpivot.table.span.HierarchyHeaderFactory;
import net.sf.jpivotart.jpivot.table.span.IgnorePropertiesHierarchyHeaderFactory;
import net.sf.jpivotart.jpivot.table.span.LevelHeaderFactory;
import net.sf.jpivotart.jpivot.table.span.Span;
import net.sf.jpivotart.jpivot.table.span.SpanCalc;
...
public class RowAxisBuilderImpl extends AxisBuilderSupport implements RowAxisBuilder, RowAxisConfig {
  ...
  /**
   * @see net.sf.jpivotart.jpivot.table.AxisBuilder#getColumnCount()
   */
  ...
  /**
   * @see net.sf.jpivotart.jpivot.table.AxisBuilder#getRowCount()
   */
