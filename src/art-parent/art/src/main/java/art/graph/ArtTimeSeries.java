...
/**
 * <b>ArtTimeSeries</b> is used to chart lines over a timeframe (TIMESTAMP sql
 * type). <br> See <i>artGraph</i> interface API for description and usage
 * example.
 *
 ...
 * column must be a TIMESTAMP datatype. </li> <li>(optional) if
 ...
 * <code>select TIMESTAMP [, HyperLink] , SERIES, NUMBER1 from ...</code> <br>
...
public class ArtTimeSeries implements ArtGraph, DatasetProducer, XYItemLinkGenerator, XYToolTipGenerator, ChartPostProcessor, Serializable {
	...
	private static final Logger logger = LoggerFactory.getLogger(ArtTimeSeries.class);
	String title = "Title";
