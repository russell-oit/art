...
/**
 * Represents a user group fixed parameter value
 * 
 * @author Timothy Anyona
 */
public class UserGroupFixedParamValue implements Serializable {
	...
	public int hashCode() {
		int hash = 3;
		hash = 41 * hash + Objects.hashCode(this.fixedParamValueKey);
		return hash;
	}
	...
	public boolean equals(Object obj) {
		...
		final UserGroupFixedParamValue other = (UserGroupFixedParamValue) obj;
	...
	public String toString() {
		return "UserGroupFixedParamValue{" + "fixedParamValueKey=" + fixedParamValueKey + '}';
	}
