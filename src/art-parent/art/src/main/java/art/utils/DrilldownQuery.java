...
public class DrilldownQuery {
	...
	public boolean create(Connection conn, int qId, int position) {
		...
		try {
			String SQL = "SELECT ADQ.QUERY_ID, ADQ.DRILLDOWN_QUERY_ID,"
					+ " ADQ.DRILLDOWN_QUERY_POSITION "
					+ " , ADQ.DRILLDOWN_TITLE, ADQ.DRILLDOWN_TEXT, ADQ.OUTPUT_FORMAT,"
					+ " AQ.NAME, ADQ.OPEN_IN_NEW_WINDOW "
