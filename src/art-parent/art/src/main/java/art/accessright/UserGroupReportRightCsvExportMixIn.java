...
/**
 * Enables custom handling of csv export of user group report rights where
 * JsonUnwrapped is used for csv export but not for json export
 *
 * @author Timothy Anyona
 */
public abstract class UserGroupReportRightCsvExportMixIn extends UserGroupReportRight {
