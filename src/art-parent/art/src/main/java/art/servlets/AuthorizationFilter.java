...
public class AuthorizationFilter implements Filter {
	...
	private boolean canAccessPage(String page, User user, HttpSession session) {
		...
		if (StringUtils.equals(page, "reports") || StringUtils.equals(page, "showReport")
		...
		} else if (StringUtils.equals(page, "connections") || StringUtils.endsWith(page, "Connection")
				|| StringUtils.equals(page, "resetAllConnections")) {
			//senior admins and above
			if (accessLevel >= AccessLevel.SeniorAdmin.getValue()) {
				authorised = true;
			}
		...
		} else if (StringUtils.equals(page, "drilldowns") || StringUtils.endsWith(page, "Drilldown")) {
			//junior admins and above
			if (accessLevel >= AccessLevel.JuniorAdmin.getValue()) {
				authorised = true;
			}
