...
public class ScheduleHolidayService {
	 ...
	 */
	@CacheEvict(value = {"schedules", "holidays"}, allEntries = true)
	public void deleteAllScheduleHolidaysForSchedule(int scheduleId) throws SQLException {
	 ...
	 */
	@CacheEvict(value = {"schedules", "holidays"}, allEntries = true)
	public void addScheduleHolidays(int scheduleId, List<Holiday> holidays) throws SQLException {
		...
		String action = "add";
		updateScheduleHolidays(action, schedules, holidayIds.toArray(new Integer[0]));
	}
	 ...
	 */
	@CacheEvict(value = {"schedules", "holidays"}, allEntries = true)
	public void updateScheduleHolidays(String action, Integer[] schedules, Integer[] holidays) throws SQLException {
