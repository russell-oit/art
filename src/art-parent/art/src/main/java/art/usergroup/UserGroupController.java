...
public class UserGroupController {
	...
	public String showAddUserGroup(Model model) {
		...
		return prepareUserGroup("add", model);
	}
	...
	public String showEditUserGoup(@RequestParam("id") Integer id, Model model) {
		...
		return prepareUserGroup("edit", model);
	}
	 ...
	 * @return
	 */
	private String prepareUserGroup(String action, Model model) {
		try {
