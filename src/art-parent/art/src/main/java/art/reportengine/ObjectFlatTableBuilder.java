...
/**
 * Modification of net.sf.reportengine.components.FlatTableBuilder to use
 * Objects instead of Strings
 *
 * @author dragos balan
 * @author Timothy Anyona
 */
public class ObjectFlatTableBuilder {
	 ...
	 *
	 * @param input the input for this component
	 */
	public ObjectFlatTableBuilder(TableInput input) {
		this.tableInput = input;
	}

	/**
	 * instructs the builder to show the totals in accordance with the show
	 * parameter
	 *
	 * @param show	true or false
	 * @return	this builder
	 */
	public ObjectFlatTableBuilder showTotals(boolean show) {
	 ...
	 * @return
	 */
	public ObjectFlatTableBuilder showTotals() {
	 ...
	 * @return
	 */
	public ObjectFlatTableBuilder showGrandTotal(boolean show) {
	 ...
	 * @return
	 */
	public ObjectFlatTableBuilder showGrandTotal() {
	 ...
	 * @return
	 */
	public ObjectFlatTableBuilder showDataRows(boolean show) {
	 ...
	 * @return
	 */
	public ObjectFlatTableBuilder showDataRows() {
	 ...
	 * @return
	 */
	public ObjectFlatTableBuilder sortValues() {
	...
	/**
	 * adds a new column to the table based on the information found on the
	 * input column having the columnIndex index
	 *
	 * @param columnIndex	the index of the column (counted from zero in the
	 * input)
	 * @return
	 */
	public ObjectFlatTableBuilder addDataColumn(int columnIndex) {
		return addDataColumn(new DefaultDataColumn.Builder(columnIndex).build());
	}

	/**
	 * adds a new column tot he table based on the provided input column and
	 * having the specified header
	 *
	 * @param columnIndex
	 * @param columnHeader
	 * @return
	 */
	public ObjectFlatTableBuilder addDataColumn(int columnIndex, String columnHeader) {
	 ...
	 * @return
	 */
	public ObjectFlatTableBuilder addDataColumn(DataColumn dataCol) {
	 ...
	 */
	@Deprecated
	public ObjectFlatTableBuilder dataColumns(List<? extends DataColumn> dataCols) {
	 ...
	 */
	@Deprecated
	public ObjectFlatTableBuilder groupColumns(List<? extends GroupColumn> groupCols) {
	...
	/**
	 * adds a group column to the table (the column is referenced by its
	 * zero-based index)
	 *
	 * @param columnIndex
	 * @return
	 */
	public ObjectFlatTableBuilder addGroupColumn(int columnIndex) {
	 ...
	 * @return
	 */
	public ObjectFlatTableBuilder addGroupColumn(GroupColumn groupCol) {
		this.groupColumns.add(groupCol);
		return this;
	}

	/**
	 * builds the flat table based on the parameters provided by the user of
	 * this class
	 *
	 * @return
	 */
	public FlatTable build() {
		return new ObjectFlatTable(tableInput,
				dataColumns,
				groupColumns,
				showTotals.getValue(),
