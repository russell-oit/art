...
/**
 * Represents encryptor types
 *
 * @author Timothy Anyona
 */
public enum EncryptorType {

	AESCrypt("AES Crypt"), OpenPGP("OpenPGP"), Password("Password");

	private final String value;

	private EncryptorType(String value) {
		this.value = value;
	}
	 ...
	 */
	public static List<EncryptorType> list() {
		//use a new list as Arrays.asList() returns a fixed-size list. can't add or remove from it
		List<EncryptorType> items = new ArrayList<>();
	 ...
	 */
	public static EncryptorType toEnum(String value) {
		for (EncryptorType v : values()) {
