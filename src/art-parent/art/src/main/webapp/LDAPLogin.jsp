    ...
    <body onload="javascript:document.getElementById('username').focus();">
        <table class="art login">
			...
			<form name="login" method="post" action="${pageContext.request.contextPath}/execLDAPLogin.jsp">
                ...
                <tr>
					<td class="loginLabel">
						<label for="ldapusername"><%=messages.getString("username")%></label>
					</td>
                    <td class="loginField">
                ...
                <tr>
                    <td class="loginLabel">
						<label for="ldappassword"><%=messages.getString("password")%></label>
					</td>
                    <td class="loginField">
                        <input name="ldapusername" id="ldappassword" type="password" maxLength="40" size="25">
                    </td>
                </tr>
                <tr>
