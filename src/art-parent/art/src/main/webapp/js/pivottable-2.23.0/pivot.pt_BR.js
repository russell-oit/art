(function() {
  ...
  callWithJQuery(function($) {
    ...
    if (gcr) {
      $.pivotUtilities.locales.pt_BR.gchart_renderers = {
    ...
    if (d3r) {
      $.pivotUtilities.locales.pt_BR.d3_renderers = {
        "Mapa de Árvore": d3r["Treemap"]
      };
    }
    if (c3r) {
      $.pivotUtilities.locales.pt_BR.c3_renderers = {
    ...
    return $.pivotUtilities.locales.pt_BR;
  });
