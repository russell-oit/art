(function() {
  ...
  callWithJQuery(function($) {
    ...
    if (gcr) {
      $.pivotUtilities.locales.zh_CN.gchart_renderers = {
    ...
    if (d3r) {
      $.pivotUtilities.locales.zh_CN.d3_renderers = {
        "树图": d3r["Treemap"]
      };
    }
    if (c3r) {
      $.pivotUtilities.locales.zh_CN.c3_renderers = {
        "C3 折线图": c3r["Line Chart"],
        "C3 柱形图": c3r["Bar Chart"],
        "C3 堆栈柱形图": c3r["Stacked Bar Chart"],
        "C3 面积图": c3r["Area Chart"],
		"C3 水平条图": c3r["Horizontal Bar Chart"],
		"C3 水平条形图": c3r["Horizontal Stacked Bar Chart"],
        "C3 散点图": c3r["Scatter Chart"]
      };
    }
	if (plr) {
      $.pivotUtilities.locales.zh_CN.plotly_renderers = {
        "绘制行图": plr["Line Chart"],
        "Plotly柱状图": plr["Bar Chart"],
        "堆叠条形图": plr["Stacked Bar Chart"],
		"绘制区域图": plr["Area Chart"],
		"Plotly水平条图": plr["Horizontal Bar Chart"],
		"Plotly Horizontal Stacked Bar Chart": plr["Horizontal Stacked Bar Chart"],
		"Plotly 散点图": plr["Scatter Chart"],
		"绘制多个饼图": plr["Multiple Pie Chart"]
      };
    }
	if (er) {
		$.pivotUtilities.locales.zh_CN.export_renderers = {
			"TSV 导出" : er["TSV Export"]
		};
	}
	if (sr) {
		$.pivotUtilities.locales.zh_CN.subtotal_renderers = {
			"带小计的表格" : sr["Table With Subtotal"],
			"带小计条形图的表格" : sr["Table With Subtotal Bar Chart"],
			"带小计热力图的表格" : sr["Table With Subtotal Heatmap"],
			"带行小计热力图的表格" : sr["Table With Subtotal Row Heatmap"],
			"带列小计热力图的表格" : sr["Table With Subtotal Col Heatmap"]
		};
	}
    return $.pivotUtilities.locales.zh_CN;
  });
