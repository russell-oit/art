...
<spring:message code="holidays.message.linkedRecordsExist" var="linkedRecordsExistText" javaScriptEscape="true"/>
	...
	<jsp:attribute name="javascript">
		<script type="text/javascript">
			$(document).ready(function () {
				...
				var deleteRecordUrl = "${pageContext.request.contextPath}/deleteHoliday";
				var deleteRecordsUrl = "${pageContext.request.contextPath}/deleteHolidays";
				...
				var exportRecordsUrl = "${pageContext.request.contextPath}/exportRecords?type=Holidays";
		...
		<table id="holidays" class="table table-bordered table-striped table-condensed">
			...
			<tbody>
				<c:forEach var="holiday" items="${holidays}">
					<tr id="row_${holiday.holidayId}" 
						data-id="${holiday.holidayId}" 
