<%-- 
    Document   : jobsWithDestination
    Created on : 10-Dec-2017, 17:50:26
...
<spring:message code="page.title.destinationUsage" var="pageTitle"/>
...
<t:mainPageWithPanel title="${pageTitle}" mainColumnClass="col-md-8 col-md-offset-2"
	...
	<jsp:body>
		...
		<div class="text-center">
			<p>
				<b><spring:message code="page.text.destination"/>:</b> ${encode:forHtmlContent(destination.name)}
			</p>
			<p>
