<%-- 
    Document   : editEncryptors
    Created on : 02-Nov-2017, 19:41:33
...
<spring:message code="page.title.editEncryptors" var="pageTitle"/>
...
//					$('#active').prop('disabled', false);
	...
	<jsp:body>
		<spring:url var="formUrl" value="/saveEncryptors"/>
		<form:form class="form-horizontal" method="POST" action="${formUrl}" modelAttribute="multipleEncryptorEdit">
			<fieldset>
