<%-- 
    Document   : editUserGroupFixedParamValue
    Created on : 02-Apr-2018, 22:52:12
...
<spring:message code="page.title.editFixedParamValue" var="pageTitle"/>
...
<t:mainPageWithPanel title="${pageTitle}" mainColumnClass="col-md-6 col-md-offset-3">
	...
	<jsp:body>
		<spring:url var="formUrl" value="/saveUserGroupFixedParamValue"/>
		<form:form class="form-horizontal" method="POST" action="${formUrl}" modelAttribute="fixedParamValue">
			<fieldset>
				...
				<form:hidden path="fixedParamValueKey"/>
