...
<spring:message code="page.title.startConditionUsage" var="pageTitle"/>
...
<t:mainPageWithPanel title="${pageTitle}" mainColumnClass="col-md-8 col-md-offset-2"
	...
	<jsp:body>
		...
		<div class="text-center">
			<p>
				<b><spring:message code="page.text.startCondition"/>:</b> ${encode:forHtmlContent(startCondition.name)}
			</p>
		</div>
