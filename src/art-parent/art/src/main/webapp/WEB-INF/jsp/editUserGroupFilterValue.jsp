<%-- 
    Document   : editUserGroupFilterValue
    Created on : 20-May-2014, 10:54:29
    Author     : Timothy Anyona

Edit user group filter value
--%>
...
<t:mainPageWithPanel title="${pageTitle}" mainColumnClass="col-md-6 col-md-offset-3">
	...
	<jsp:body>
		<spring:url var="formUrl" value="/app/saveUserGroupFilterValue.do"/>
