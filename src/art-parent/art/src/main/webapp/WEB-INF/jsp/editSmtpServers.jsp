<%-- 
    Document   : editSmtpServers
    Created on : 14-Dec-2017, 12:54:27
...
<spring:message code="page.title.editSmtpServers" var="pageTitle"/>
...
//					$('#active').prop('disabled', false);
	...
	<jsp:body>
		<spring:url var="formUrl" value="/saveSmtpServers"/>
		<form:form class="form-horizontal" method="POST" action="${formUrl}" modelAttribute="multipleSmtpServerEdit">
			<fieldset>
