<%-- 
    Document   : reportsInReportGroup
    Created on : 10-Dec-2017, 17:17:08
...
<spring:message code="page.title.reportsInReportGroup" var="panelTitle"/>
<c:set var="pageTitle">
	${panelTitle} - ${reportGroup.name}
</c:set>
