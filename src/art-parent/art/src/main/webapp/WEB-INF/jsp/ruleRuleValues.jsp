<%-- 
    Document   : ruleRuleValues
    Created on : 12-Nov-2017, 15:06:29
...
<spring:message code="page.title.ruleRuleValues" var="pageTitle"/>
...
<t:mainPageWithPanel title="${pageTitle}" mainColumnClass="col-md-10 col-md-offset-1"
	...
	<jsp:attribute name="javascript">
		<script type="text/javascript">
			$(document).ready(function () {
				...
				var deleteRecordUrl = "${pageContext.request.contextPath}/deleteRuleValue";
	...
	<jsp:body>
		...
		<div class="text-center">
			<b><spring:message code="page.text.rule"/>:</b> ${encode:forHtmlContent(rule.name)}
		</div>
						...
						<td>
							<div class="btn-group">
								<a class="btn btn-default" 
								   href="${pageContext.request.contextPath}/editUserRuleValue?id=${userRuleValue.ruleValueKey}&returnRuleId=${rule.ruleId}">
				...
				<c:forEach var="userGroupRuleValue" items="${userGroupRuleValues}">
					<tr data-name="${encode:forHtmlAttribute(userGroupRuleValue.userGroup.name)} -
						...
						<td>
							<div class="btn-group">
								<a class="btn btn-default" 
								   href="${pageContext.request.contextPath}/editUserGroupRuleValue?id=${userGroupRuleValue.ruleValueKey}&returnRuleId=${rule.ruleId}">
									<i class="fa fa-pencil-square-o"></i>
									<spring:message code="page.action.edit"/>
								</a>
								<button type="button" class="btn btn-default deleteRecord">
