<%-- 
    ...
    Created on : 06-Apr-2016, 20:18:26
...
<spring:message code="page.title.editReports" var="pageTitle"/>
...
//					$('#active').prop('disabled', false);
	...
	<jsp:body>
		<spring:url var="formUrl" value="/app/saveReports.do"/>
		<form:form class="form-horizontal" method="POST" action="${formUrl}" modelAttribute="multipleReportEdit">
			<fieldset>
