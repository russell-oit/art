<%-- 
    ...
    Created on : 14-Nov-2017, 19:26:56
...
<spring:message code="page.title.editDestinations" var="pageTitle"/>
...
//					$('#active').prop('disabled', false);
	...
	<jsp:body>
		<spring:url var="formUrl" value="/saveDestinations"/>
		<form:form class="form-horizontal" method="POST" action="${formUrl}" modelAttribute="multipleDestinationEdit">
			<fieldset>
