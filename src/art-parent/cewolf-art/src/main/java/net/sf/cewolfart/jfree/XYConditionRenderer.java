...
import net.sf.cewolfart.util.Expr;
...
public class XYConditionRenderer extends XYLineAndShapeRenderer {
    ...
    public boolean getItemShapeFilled (int series, int item) {
 	...
 	private boolean evaluateCondition (String cond, int series, int item) {
		...
		vars.put("s", Double.valueOf(series));
		vars.put("i", Double.valueOf(item));
		vars.put("x", Double.valueOf(ds.getXValue(series,item)));
		vars.put("y", Double.valueOf(ds.getYValue(series,item)));
