...
import net.sf.cewolfart.taglib.util.MIMEExtensionHelper;
...
public class ChartImgTag extends HTMLImgTag implements CewolfRootTag, Mapped
{
	...
	private static final Logger logger = LoggerFactory.getLogger(ChartImgTag.class);
  ...
  /**
   * @see net.sf.cewolfart.taglib.html.AbstractHTMLBaseTag#getTagName()
   */
  ...
  /**
   * @see net.sf.cewolfart.taglib.html.AbstractHTMLBaseTag#writeAttributes(Writer)
   */
