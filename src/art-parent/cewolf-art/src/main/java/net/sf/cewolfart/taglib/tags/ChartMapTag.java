...
import net.sf.cewolfart.tooltips.ToolTipGenerator;
...
public class ChartMapTag extends CewolfTag {
	...
	private static final Logger logger = LoggerFactory.getLogger(ChartMapTag.class);
	...
	public void enableToolTips(Writer out, final boolean isIE) throws IOException {
		...
		//https://sourceforge.net/p/cewolf/discussion/192228/thread/2ffe3b45/
		if (!PageUtils.isToolTipsEnabled(pageContext) && !isIE && StringUtils.isNotBlank(overLibURL)) {
	 ...
	 *
	 * @param useJFreeChartTooltipGenerator the useJFreeChartTooltipGenerator to
	 * set.
	 */
