...
public abstract class HeatMapUtilities {
     ...
     * @return The dataset.
     */
    public static XYDataset extractRowFromHeatMapDataset (HeatMapDataset dataset, int row,@SuppressWarnings("rawtypes") Comparable seriesName) {
     ...
     * @return The dataset.
     */
    public static XYDataset extractColumnFromHeatMapDataset (HeatMapDataset dataset, int column,@SuppressWarnings("rawtypes") Comparable seriesName) {
        XYSeries series = new XYSeries(seriesName);
